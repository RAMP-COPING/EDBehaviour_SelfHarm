...
glad_baseline <- readRDS(file = "../data_cleaned/BASELINE_glad2022-09-23.rds")
dim(glad_baseline)

edgi_baseline <- readRDS(file = "../data_cleaned/BASELINE_edgi2022-09-23.rds")
dim(edgi_baseline)

nbr_baseline <- readRDS(file = "../data_cleaned/BASELINE_nbr2022-09-23.rds")
dim(nbr_baseline)

ramp_baseline <- readRDS(file = "../data_cleaned/BASELINE_ramp2022-09-23.rds")
dim(ramp_baseline)
```
...
baseline_ED_groups_data <- readRDS(file = "../data_cleaned/ED_BASELINE_groups2022-09-23.rds")
...
```{r Read in ED data ED grouping}
OCD_screener <- readRDS(file = "../data_cleaned/OCD_screener2022-09-23.rds")
...
taf_ramp <- readRDS(file = "../data_cleaned/TAF_ramp2022-09-23.rds")
dim(taf_ramp)

taf_coping <- readRDS(file = "../data_cleaned/TAF_coping2022-09-23.rds")
dim(taf_coping)

# EDEQ (eating disorder behaviour)
edeq_coping_screener <- readRDS(file = "../data_cleaned/EDEQ_screener_coping2022-09-23.rds")
dim(edeq_coping_screener)

edeq_ramp_screener <- readRDS(file = "../data_cleaned/EDEQ_screener_ramp2022-09-23.rds")
dim(edeq_ramp_screener)

# Virus questionnaire
virus_ramp <- readRDS(file = "../data_cleaned/VIRUS_ramp_followup2022-09-23.rds")
dim(virus_ramp)
  
virus_coping <- readRDS(file = "../data_cleaned/VIRUS_coping_followup2022-09-23.rds")
dim(virus_coping)

# Loss 
loss_ramp <- readRDS(file = "../data_cleaned/LOSS_ramp_followup2022-09-23.rds")
dim(loss_ramp)

loss_coping <- readRDS(file = "../data_cleaned/LOSS_coping_followup2022-09-23.rds")
dim(loss_coping)

# Demographics (living situation and vulnerable group member)
dem_coping_followup <- readRDS(file = "../data_cleaned/DEM_followup_coping2022-09-23.rds")
dim(dem_coping_followup)

dem_ramp_followup <- readRDS(file = "../data_cleaned/DEM_followup_ramp2022-09-23.rds")
dim(dem_ramp_followup)

# Respiratory questionnaire
resp_coping_followup <- readRDS(file = "../data_cleaned/RESP_coping_followup2022-09-23.rds")
dim(resp_coping_followup)

resp_ramp_followup <- readRDS(file = "../data_cleaned/RESP_ramp_followup2022-09-23.rds")
