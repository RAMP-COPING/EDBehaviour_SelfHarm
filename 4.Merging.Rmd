...
glad_baseline <- readRDS(file = "../data_cleaned/BASELINE_glad2022-09-22.rds")
dim(glad_baseline)

edgi_baseline <- readRDS(file = "../data_cleaned/BASELINE_edgi2022-09-22.rds")
dim(edgi_baseline)
...
baseline_ED_groups_data <- readRDS(file = "../data_cleaned/ED_BASELINE_groups2022-06-20.rds")
