...
dat %>%
  ...
  select(starts_with("ed_scid5.regular_episodes_eating_binges_"))
```
...
# Check NAs
dat %>%
  filter(outcome_phase_binge_eating == "Not answered") %>%
  select(starts_with("ed_scid5.regular_episodes_eating_binges_."))
```
  ...
  mutate(positive_covid_test_before_BE =
           case_when(
             ...
             # First exposure NOT before first experience of outcome
                    ...
                    positive_covid_test_BE_16b == "To drop"  | 
                    
                  # Not answered whether they'd experienced binge eating 
                    outcome_phase_binge_eating == "Not answered" ~ "To drop", 
...
dat <- dat %>%
  mutate(positive_covid_test_before_BE_final =
           case_when(
             # Need to drop people who first experienced outcome before first experience of exposure, and need to drop people who never answered whether they'd experienced the outcome
                     ...
                     positive_covid_test_before_BE == "Positive test before binge eating" ~ "Yes" # Those who had outcome AND exposure, only include those who had exposure first
                    )
  )
...
```
263 people endorsed binge eating in a phase before they endorsed a positive COVID test and/or being unwell with COVID.
...
dat <- dat %>%
  mutate(losing_someone_before_BE =
           case_when(
             ...
             # First lost someone NOT before first experience of binge eating
                    ...
                    lost_someone_BE_16b == "To drop"  | 
                    
                    # Not answered whether they'd experienced binge eating 
                    outcome_phase_binge_eating == "Not answered"  | 
                      
                    # Not answered whether they'd lost someone
                    exposure_phase_losing_someone == "Not answered or PNTA" ~ "To drop", # Need to be dropped
