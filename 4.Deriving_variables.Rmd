...
#Collapse age category to of 16-18 and 19-25 to 16-25 (small categories otherwise)

dat <- dat %>%
  mutate(age_category_COVID_baseline = 
           case_when(
                     
             ((cohort_name == "coping_nbr" |
               cohort_name == "ramp") &
            ...
            ((cohort_name == "coping_glad" |
               cohort_name == "coping_edgi") &
                      age_category_COPING == "76-80" ~ "76-80"),
             
            ((cohort_name == "coping_glad" |
               cohort_name == "coping_edgi") &
                      age_category_COPING == "81-85" ~ "81-85"),
            
            (( cohort_name == "coping_glad" |
               cohort_name == "coping_edgi") &
                      age_category_COPING == "86-90" ~ "86-90"),
            
            (( cohort_name == "coping_glad" |
               cohort_name == "coping_edgi") &
                      age_category_COPING == "91-100" ~ "91-100")
