...
edeq.ramp.followupb.raw.id <- edeq.ramp.followupb.raw.id  %>%
  select(ID,
         `edeq.deliberately_limit_amount_influence_numeric_Wave 2b`,
         `edeq.deliberately_limit_amount_influence_numeric_Wave 3b`,
         `edeq.deliberately_limit_amount_influence_numeric_Wave 4b`,
         `edeq.deliberately_limit_amount_influence_numeric_Wave 6`,
         `edeq.deliberately_limit_amount_influence_numeric_Wave 8`,
         `edeq.calories_made_body_shape_numeric_Wave 2b`,
         `edeq.calories_made_body_shape_numeric_Wave 3b`,
         `edeq.calories_made_body_shape_numeric_Wave 4b`,
         `edeq.calories_made_body_shape_numeric_Wave 6`,
         `edeq.calories_made_body_shape_numeric_Wave 8`,
         `edeq.weight_influenced_person_numeric_Wave 2b`,
         `edeq.weight_influenced_person_numeric_Wave 3b`,
         `edeq.weight_influenced_person_numeric_Wave 4b`,
         `edeq.weight_influenced_person_numeric_Wave 6`,
         `edeq.weight_influenced_person_numeric_Wave 8`,
         `edeq.dissatisfied_shape_weight_numeric_Wave 2b`,
         `edeq.dissatisfied_shape_weight_numeric_Wave 3b`,
         `edeq.dissatisfied_shape_weight_numeric_Wave 4b`,
         `edeq.dissatisfied_shape_weight_numeric_Wave 6`,
         `edeq.dissatisfied_shape_weight_numeric_Wave 8`,
         `edeq.eating_behaviours_distressed_concerns_numeric_Wave 2b`,
         `edeq.eating_behaviours_distressed_concerns_numeric_Wave 3b`,
         `edeq.eating_behaviours_distressed_concerns_numeric_Wave 4b`,
         `edeq.eating_behaviours_distressed_concerns_numeric_Wave 6`,
         `edeq.eating_behaviours_distressed_concerns_numeric_Wave 8`,
         `edeq.actively_been_monitoring_your_shape_or_weight_numeric_Wave 2b`,
         `edeq.actively_been_monitoring_your_shape_or_weight_numeric_Wave 3b`,
         `edeq.actively_been_monitoring_your_shape_or_weight_numeric_Wave 4b`,
         `edeq.actively_been_monitoring_your_shape_or_weight_numeric_Wave 6`,
         `edeq.actively_been_monitoring_your_shape_or_weight_numeric_Wave 8`,
         `edeq.regard_lost_control_eaten_numeric_Wave 2b`,
         `edeq.regard_lost_control_eaten_numeric_Wave 3b`,
         `edeq.regard_lost_control_eaten_numeric_Wave 4b`,
         `edeq.regard_lost_control_eaten_numeric_Wave 6`,
         `edeq.regard_lost_control_eaten_numeric_Wave 8`,
         `edeq.sick_means_made_shape_numeric_Wave 2b`,
         `edeq.sick_means_made_shape_numeric_Wave 3b`,
         `edeq.sick_means_made_shape_numeric_Wave 4b`,
         `edeq.sick_means_made_shape_numeric_Wave 6`,
         `edeq.sick_means_made_shape_numeric_Wave 8`,
         `edeq.diuretics_laxatives_means_shape_numeric_Wave 2b`,
         `edeq.diuretics_laxatives_means_shape_numeric_Wave 3b`,
         `edeq.diuretics_laxatives_means_shape_numeric_Wave 4b`,
         `edeq.diuretics_laxatives_means_shape_numeric_Wave 6`,
         `edeq.diuretics_laxatives_means_shape_numeric_Wave 8`,
         `edeq.compulsive_driven_burn_calories_numeric_Wave 2b`,
         `edeq.compulsive_driven_burn_calories_numeric_Wave 3b`,
         `edeq.compulsive_driven_burn_calories_numeric_Wave 4b`,
         `edeq.compulsive_driven_burn_calories_numeric_Wave 6`,
         `edeq.compulsive_driven_burn_calories_numeric_Wave 8`,
         `edeq.nibbled_picked_snacks_grazed_numeric_Wave 2b`,
         `edeq.nibbled_picked_snacks_grazed_numeric_Wave 3b`,
         `edeq.nibbled_picked_snacks_grazed_numeric_Wave 4b`,
         `edeq.nibbled_picked_snacks_grazed_numeric_Wave 6`,
         `edeq.nibbled_picked_snacks_grazed_numeric_Wave 8`,
         `edeq.felt_anxious_blue_bored_numeric_Wave 2b`,
         `edeq.felt_anxious_blue_bored_numeric_Wave 3b`,
         `edeq.felt_anxious_blue_bored_numeric_Wave 4b`,
         `edeq.felt_anxious_blue_bored_numeric_Wave 6`,
         `edeq.felt_anxious_blue_bored_numeric_Wave 8`,
         `edeq.felt_anxious_blue_bored.1_numeric_Wave 2b`,
         `edeq.felt_anxious_blue_bored.1_numeric_Wave 3b`,
         `edeq.felt_anxious_blue_bored.1_numeric_Wave 4b`,
         `edeq.felt_anxious_blue_bored.1_numeric_Wave 6`,
         `edeq.felt_anxious_blue_bored.1_numeric_Wave 8`)
}
```
...
Age (age_category, age_category_numeric) xx
Sex xx
Gender xx
Education  (highest education_prepan x, and highest_education_prepan_numeric x, highest_education, highest_education) x
Employment x
Employment change (EDGI & GLAD only) - *check follow up RAMP and NBR x
Ethnicity xx
key worker x
