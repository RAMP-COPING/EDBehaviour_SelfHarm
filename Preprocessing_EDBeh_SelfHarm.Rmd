...
##Exclude people who answered baseline questionnaire after 30th April 
...
##Exclude people who answered baseline questionnaire after 30th April (want their current symptoms at baseline)
1. Change date format
```{r}
if(RAMP == TRUE){
...
ramp.7 <- edeq.ramp.baseline.raw.id %>% #Baseline BEFORE 30th April
  select(ID,
  cohort_name,
...
```{r export data}
if(GLAD == TRUE) {
saveRDS(object = dat.raw.glad, file = "../data_cleaned/NEW_baseline_glad.rds")
}

if(EDGI == TRUE) {
saveRDS(object = dat.raw.edgi, file = "../data_cleaned/NEW_baseline_edgi.rds")
  
}
if(RAMP == TRUE) {
  saveRDS(object = dat.raw.ramp, file = "../data_cleaned/NEW_baseline_ramp.rds")
}


if(NBR == TRUE) {
  saveRDS(object = dat.raw.nbr, file = "../data_cleaned/NEW_baseline_nbr.rds")
}
