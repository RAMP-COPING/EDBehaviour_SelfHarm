...
## 2. Change follow up to long format, remove duplicates, rename columns to indicate wave AND variable (e.g. wave1a_worth_living), then combine (rbind) - RAMP
```{r change to long format}

##Do each variable - worth living
...
##Identify duplicates from that variable dataset
taf.ramp.followupa.raw.id.worth_living.dupids <- taf.ramp.followupa.raw.id.worth_living$ID[(taf.ramp.followupa.raw.id.worth_living$`Wave 1a` > 1 | taf.ramp.followupa.raw.id.worth_living$`Wave 2a` > 1 |
                         taf.ramp.followupa.raw.id.worth_living$`Wave 3a` > 1 | taf.ramp.followupa.raw.id.worth_living$`Wave 4a` > 1 |
                         taf.ramp.followupa.raw.id.worth_living$`Wave 5` > 1 |taf.ramp.followupa.raw.id.worth_living$`Wave 7` > 1)]


taf.ramp.followupa.raw.id.worth_living.dupids <- unique(taf.ramp.followupa.raw.id.worth_living.dupids)

##Remove from data
taf.ramp.followupa.raw.id.worth_living.NO_dupids <- taf.ramp.followupa.raw.id.worth_living.dupids[(taf.ramp.followupa.raw.id.worth_living.dupids$ID %!in% taf.ramp.followupa.raw.id.worth_living.dupids),]
```
##Rename columns to capture wave AND variable name
