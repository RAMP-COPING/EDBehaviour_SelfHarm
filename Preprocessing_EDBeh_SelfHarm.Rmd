...
edeq.ramp.followupb.raw.id <- edeq.ramp.followupb.raw.id  %>%
  select(ID,
         ...
         `edeq.actively_been_monitoring_your_shape_or_weight_.Wave 1b`,
         `edeq.actively_been_monitoring_your_shape_or_weight_.Wave 2b`,
         `edeq.actively_been_monitoring_your_shape_or_weight_.Wave 3b`,
         `edeq.actively_been_monitoring_your_shape_or_weight_.Wave 4b`,
         `edeq.actively_been_monitoring_your_shape_or_weight_.Wave 6`,
         `edeq.actively_been_monitoring_your_shape_or_weight_.Wave 8`,
          `edeq.regard_lost_control_eaten_.Wave 1b`,
         `edeq.regard_lost_control_eaten_.Wave 2b`,
         `edeq.regard_lost_control_eaten_.Wave 3b`,
         `edeq.regard_lost_control_eaten_.Wave 4b`,
         `edeq.regard_lost_control_eaten_.Wave 6`,
         `edeq.regard_lost_control_eaten_.Wave 8`,
          `edeq.sick_means_made_shape_.Wave 1b`,
         `edeq.sick_means_made_shape_.Wave 2b`,
         `edeq.sick_means_made_shape_.Wave 3b`,
         `edeq.sick_means_made_shape_.Wave 4b`,
         `edeq.sick_means_made_shape_.Wave 6`,
         `edeq.sick_means_made_shape_.Wave 8`,
         `edeq.diuretics_laxatives_means_shape_.Wave 1b`,
         `edeq.diuretics_laxatives_means_shape_.Wave 2b`,
         `edeq.diuretics_laxatives_means_shape_.Wave 3b`,
         `edeq.diuretics_laxatives_means_shape_.Wave 4b`,
         `edeq.diuretics_laxatives_means_shape_.Wave 6`,
         `edeq.diuretics_laxatives_means_shape_.Wave 8`,
          `edeq.compulsive_driven_burn_calories_.Wave 1b`,
         `edeq.compulsive_driven_burn_calories_.Wave 2b`,
         `edeq.compulsive_driven_burn_calories_.Wave 3b`,
         `edeq.compulsive_driven_burn_calories_.Wave 4b`,
         `edeq.compulsive_driven_burn_calories_.Wave 6`,
         `edeq.compulsive_driven_burn_calories_.Wave 8`,
