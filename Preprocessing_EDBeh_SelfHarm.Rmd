...
##Should do this AFTER split by waves in follow up data(i.e. one person should not have multiple data for one wave [e.g. duplicated ID in wave 1a dataset], but one person will have multiple wave data [e.g. wave 1a, wave 1b, etc])
...
ggplot(taf.ramp.followupa.raw.id,
       aes(taf.worth_living_life_people_followupA, 
           fill = wave_A_taf)) +
        geom_bar(size = 1,
                 shape = 23,
                 colour = "blue",
  ...
  labs(y = "Number of participants",
     x = "Many people have thoughts that life is not worth living. Have you felt that way?",
...
##**NEED TO THINK ABUOT HOW DATA SHOULD BE IN ORDER TO PLOT IT, NEED TO BE ABLE TO GROUP BY WAVE (SO WAVE SHOULD BE A SINGEL COLUMN). WILL END WITH MULTIPLE IDS.

## 2. Change follow up to long format & remove duplicate IDs
```{r change to long format}

##Many people have thoughts that life is not worth living. Have you felt that way?	
taf.ramp.followupa.raw.id.worth_living <- taf.ramp.followupa.raw.id %>%
  pivot_wider(id_cols = ID,
              names_from = wave_A_taf,
              values_from = taf.worth_living_life_people_followupA,
              values_fn = length)

##Remove duplicate IDs
taf.ramp.followupa.raw.id.worth_living  <- taf.ramp.followupa.raw.id.worth_living  %>%
  filter(., !duplicated(ID)) 

##Life worth living, past 2 weeks
taf.ramp.followupa.raw.id.worth_living_2_weeks <- taf.ramp.followupa.raw.id %>%
  pivot_wider(id_cols = ID,
              names_from = wave_A_taf,
              values_from = taf.meant_life_end_weeks_followupA,
              values_fn = length)

##Remove duplicate IDs
taf.ramp.followupa.raw.id.worth_living_2_weeks  <- taf.ramp.followupa.raw.id.worth_living_2_weeks  %>%
  filter(., !duplicated(ID)) 


##Have you contemplated harming yourself ?
taf.ramp.followupa.raw.id.harming_self <- taf.ramp.followupa.raw.id %>%
  pivot_wider(id_cols = ID,
              names_from = wave_A_taf,
              values_from = taf.have_you_contemplated_harming_yourself_followupA,
              values_fn = length)

##Remove duplicate IDs
taf.ramp.followupa.raw.id.harming_self  <- taf.ramp.followupa.raw.id.harming_self  %>%
  filter(., !duplicated(ID)) 

##Harming self - past 2 weeks?
taf.ramp.followupa.raw.id.harming_self_2_weeks <- taf.ramp.followupa.raw.id %>%
  pivot_wider(id_cols = ID,
              names_from = wave_A_taf,
              values_from = taf.felt_weeks_past.1_followupA,
              values_fn = length)

##Remove duplicate IDs
taf.ramp.followupa.raw.id.harming_self_2_weeks  <- taf.ramp.followupa.raw.id.harming_self_2_weeks  %>%
  filter(., !duplicated(ID)) 


##In the last two weeks, have you deliberately harmed yourself, whether or not you meant to end your life?	
taf.ramp.followupa.raw.id.deliberate_harm_2_weeks <- taf.ramp.followupa.raw.id %>%
  pivot_wider(id_cols = ID,
              names_from = wave_A_taf,
              values_from = taf.meant_life_end_weeks_followupA,
              values_fn = length)
...
##Remove duplicate IDs
taf.ramp.followupa.raw.id.deliberate_harm_2_weeks  <- taf.ramp.followupa.raw.id.deliberate_harm_2_weeks  %>%
  filter(., !duplicated(ID)) 

```


##3. Rename columns to capture wave AND variable name
```{r}

##Worth living
##Many people have thoughts that life is not worth living. Have you felt that way?	
taf.ramp.followupa.raw.id.worth_living <- taf.ramp.followupa.raw.id.worth_living %>%
  setnames(., old = c('Wave 1a',
                    'Wave 2a',
                    'Wave 3a',
                    'Wave 4a',
                    'Wave 5',
                    'Wave 7'), 
         new = c('Wave1a_worth_living',
                 'Wave2a_worth_living',
                 'Wave3a_worth_living',
                 'Wave4a_worth_living',
                 'Wave5_worth_living',
...
##Worth living - past 2 weeks
##Many people have thoughts that life is not worth living. Have you felt that way in the past 2 weeks?                
taf.ramp.followupa.raw.id.worth_living_2_weeks <- taf.ramp.followupa.raw.id.worth_living_2_weeks %>%
  setnames(., old = c('Wave 1a',
                    'Wave 2a',
                    'Wave 3a',
                    ...
                    'Wave 5',
                    'Wave 7'), 
         new = c('Wave1a_worth_living_2_weeks',
                 'Wave2a_worth_living_2_weeks',
                 'Wave3a_worth_living_2_weeks',
                 'Wave4a_worth_living_2_weeks',
                 'Wave5_worth_living_2_weeks',
                 'Wave7_worth_living_2_weeks'))

##Contemplated_harming
##Have you contemplated harming yourself ?
taf.ramp.followupa.raw.id.harming_self <- taf.ramp.followupa.raw.id.harming_self %>%
  setnames(., old = c('Wave 1a',
                    'Wave 2a',
                    ...
                    'Wave 5',
                    'Wave 7'), 
         new = c('Wave1a_contemplated_harm',
                 'Wave2a_contemplated_harm',
                 'Wave3a_contemplated_harm',
                 'Wave4a_contemplated_harm',
                 'Wave5_contemplated_harm',
                 'Wave7_contemplated_harm'))

##Contemplated_harming - past 2 weeks
##Have you contemplated harming yourself in the past 2 weeks?
taf.ramp.followupa.raw.id.harming_self_2_weeks <- taf.ramp.followupa.raw.id.harming_self_2_weeks %>%
  setnames(., old = c('Wave 1a',
                    'Wave 2a',
                    'Wave 3a',
                    ...
                    'Wave 5',
                    'Wave 7'), 
         new = c('Wave1a_contemplated_harm_2_weeks',
                 'Wave2a_contemplated_harm_2_weeks',
                 'Wave3a_contemplated_harm_2_weeks',
                 'Wave4a_contemplated_harm_2_weeks',
                 'Wave5_contemplated_harm_2_weeks',
                 'Wave7_contemplated_harm_2_weeks'))
...
taf.ramp.followupa.raw.id.deliberate_harm_2_weeks <- taf.ramp.followupa.raw.id.deliberate_harm_2_weeks %>%
  setnames(., old = c('Wave 1a',
                    ...
                    'Wave 5',
                    'Wave 7'), 
         new = c('Wave1a_deliberate_harm_2_weeks',
                 'Wave2a_deliberate_harm_2_weeks',
                 'Wave3a_deliberate_harm_2_weeks',
                 'Wave4a_deliberate_harm_2_weeks',
                 'Wave5_deliberate_harm_2_weeks',
                 'Wave7_deliberate_harm_2_weeks'))
...
```{r}
taf.ramp.followupa.raw.id.worth_living

###**NEED TO SORT THE RENAMING

Seen but not answered  Prefer not to answer                    No             Yes, once   Yes, more than once 
                  -77                   -99                     0                     1                     2 

##Recoding wwave 1a life worth living
taf.ramp.followupa.raw.id.worth_living$Wave1a_deliberate_harm_2_weeks <- 
  with(taf.ramp.followupa.raw.id.worth_living,
  case_when(Wave1a_worth_living == 0 ~ "No",
            Wave1a_worth_living == 1 ~ "Yes, once",
            Wave1a_worth_living == 2 ~ "Yes, more than once",
            Wave1a_worth_living == -99 ~ "Prefer not to answer",
            Wave1a_worth_living == -77 ~ "Seen but not answered"))

freq(taf.ramp.followupa.raw.id.worth_living$Wave1a_worth_living)
...
##Recoding wwave 1a deliberate harm 2 weeks
taf.ramp.followupa.raw.id.deliberate_harm_2_weeks$Wave1a_deliberate_harm_2_weeks <- 
  with(taf.ramp.followupa.raw.id.deliberate_harm_2_weeks,
  case_when(Wave1a_deliberate_harm_2_weeks == "0" ~ "No",
            Wave1a_deliberate_harm_2_weeks == "1" ~ "Yes"))

##Recoding wwave 2a deliberate harm 2 weeks
taf.ramp.followupa.raw.id.deliberate_harm_2_weeks$Wave2a_deliberate_harm_2_weeks <- 
  with(taf.ramp.followupa.raw.id.deliberate_harm_2_weeks,
  case_when(Wave2a_deliberate_harm_2_weeks == "0" ~ "No",
            Wave2a_deliberate_harm_2_weeks == "1" ~ "Yes"))



##Recoding wwave 3a deliberate harm 2 weeks
taf.ramp.followupa.raw.id.deliberate_harm_2_weeks$Wave3a_deliberate_harm_2_weeks <- 
  with(taf.ramp.followupa.raw.id.deliberate_harm_2_weeks,
  case_when(Wave3a_deliberate_harm_2_weeks == "0" ~ "No",
            Wave3a_deliberate_harm_2_weeks == "1" ~ "Yes"))

##Recoding wwave 4a deliberate harm 2 weeks
taf.ramp.followupa.raw.id.deliberate_harm_2_weeks$Wave4a_deliberate_harm_2_weeks <- 
  with(taf.ramp.followupa.raw.id.deliberate_harm_2_weeks,
  case_when(Wave4a_deliberate_harm_2_weeks == "0" ~ "No",
            Wave4a_deliberate_harm_2_weeks == "1" ~ "Yes"))


##Recoding wwave 5 deliberate harm 2 weeks
taf.ramp.followupa.raw.id.deliberate_harm_2_weeks$Wave5_deliberate_harm_2_weeks <- 
  with(taf.ramp.followupa.raw.id.deliberate_harm_2_weeks,
  case_when(Wave5_deliberate_harm_2_weeks == "0" ~ "No",
            Wave5_deliberate_harm_2_weeks == "1" ~ "Yes"))

##Recoding wwave 7 deliberate harm 2 weeks
taf.ramp.followupa.raw.id.deliberate_harm_2_weeks$Wave7_deliberate_harm_2_weeks <- 
  with(taf.ramp.followupa.raw.id.deliberate_harm_2_weeks,
  case_when(Wave7_deliberate_harm_2_weeks == "0" ~ "No",
            Wave7_deliberate_harm_2_weeks == "1" ~ "Yes"))
...
summary(taf.ramp.followupa.raw.id.deliberate_harm_2_weeks$Wave7_deliberate_harm_2_weeks)


taf.ramp.followupa.raw.id.deliberate_harm_2_weeks %>%
  pivot_longer(Wave1a_deliberate_harm_2_weeks:Wave7_deliberate_harm_2_weeks, 
               names_to = "wave_and_question", values_to = "response") %>%
  ggplot(aes(x = response)) +
  geom_bar() +
  facet_wrap(vars(wave_and_question), ncol = 3) +
...
##4. Combine RAMP follow up cohorts, TAF (**should add follow up B, then try and plot)
```{r RAMP data frame list}
if(RAMP == TRUE) {
dfs.list <- list(
    taf.ramp.followupa.raw.id.deliberate_harm_2_weeks,
    taf.ramp.followupa.raw.id.harming_self_2_weeks,
    taf.ramp.followupa.raw.id.harming_self,
    taf.ramp.followupa.raw.id.worth_living_2_weeks,
    taf.ramp.followupa.raw.id.worth_living 
)
}
```
...
dat.raw <- plyr::join_all(
  dfs.list,
  by = c("ID") # Alternatively you can join by several columns EDGI -> "Age", "Sex", "Birthyear"
  )
...
##3. List of follow up cohorts (RAMP)
```{r RANP data frame list}
if(RAMP == TRUE) {
dfs.list <- list(
    edeq.ramp.followupb.raw.id,
    taf.ramp.followupa.raw.id,
...
2. Change to long format

#3. List of follow up cohorts (COPING)
```{r COPING data frame list}
if(COPING == TRUE) {
dfs.list <- list(
...
##Checking waves 
```{r identify wave dates ramp}
freq(dat.raw.no.dup$startDate_wavesA_taf)
dat.raw.no.dup$startDate_wavesA_taf
dat.raw.no.dup$startDate_wavesB_edeq

dat.raw.no.dup$startDate_wavesB_taf


x <- dat.raw%>%
  filter(is.na(wave_A_taf))


freq(x$startDate_wavesA_taf)
