...
```{r RANP join taf data, eval=FALSE, include=FALSE}
if(RAMP == TRUE) {
...
```{r COPING join taf, eval=FALSE, include=FALSE}
if(COPING == TRUE) {
...
dat.raw.taf.coping$taf.meant_life_end_weeks
```

##3.Remove dup IDs (TAF COPING)
```{r identify wave dates ramp}
if (COPING ==TRUE) {
...
taf.coping.followupa.raw.id$wave_taf <- factor(taf.coping.followupa.raw.id$wave_taf,
                         levels = c("Wave 2a",
                                    "Wave 2b",
                                    "Wave 3a",
                                    "Wave 3b",
...
nrow(taf.coping.followupa.raw.id)
```
