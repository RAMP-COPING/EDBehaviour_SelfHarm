...
##Exclude people who answered baseline questionnaire after 30th April (earliest follow up questionnaire filled out 30th April, however need April)
...
edeq.ramp.baseline.CUTOFF.raw.id <- edeq.ramp.baseline.raw.id %>%
  filter(startDate_baseline < as.Date("2020-04-30"))

#Drop start date baseline column in both 

edeq.ramp.baseline.CUTOFF.raw.id <- edeq.ramp.baseline.CUTOFF.raw.id %>%
...
#Filter by people who completed baseline survey before 30th april
taf.glad.coping.baseline.CUTOFF.raw.id <- taf.glad.coping.baseline.raw.id %>%
  filter(startDate_baseline < as.Date("2020-04-30"))


#Drop start date baseline column

taf.glad.coping.baseline.CUTOFF.raw.id <- taf.glad.coping.baseline.CUTOFF.raw.id %>%
  select(-c(startDate_baseline,
            startDate_baseline_numeric))
...
taf.edgi.coping.baseline.CUTOFF.raw.id <- taf.edgi.coping.baseline.raw.id %>%
  filter(startDate_baseline < as.Date("2020-04-30"))
...
taf.edgi.coping.baseline.CUTOFF.raw.id <- taf.edgi.coping.baseline.CUTOFF.raw.id %>%
  select(-c(startDate_baseline,
            startDate_baseline_numeric))
...
taf.nbr.baseline.CUTOFF.raw.id <- taf.nbr.baseline.raw.id %>%
  filter(startDate_baseline < as.Date("2020-04-30"))


#Drop start date baseline column
taf.nbr.baseline.CUTOFF.raw.id <- taf.nbr.baseline.CUTOFF.raw.id %>%
  select(-c(startDate_baseline,
            startDate_baseline_numeric))
...
#Filter by people who completed baseline survey before 30th april
taf.ramp.baseline.CUTOFF.raw.id <- taf.ramp.baseline.raw.id %>%
  filter(startDate_baseline < as.Date("2020-04-30"))


#Drop start date baseline column
taf.ramp.baseline.CUTOFF.raw.id <- taf.ramp.baseline.CUTOFF.raw.id %>%
  select(-c(startDate_baseline,
            startDate_baseline_numeric))
...
```
##Check earliest date of follow up A TAF (this will be used as cutoff for 'baseline', i.e., baseline entries only count BEFORE this date)
```{r}
if(RAMP == TRUE){

x <- as.Date(taf.ramp.followupa.raw.id$startDate_waves)
...
```
##checking for number of entries per wave!
...
##Idenfitying duplicate IDs in a single wave
```{r}
if(RAMP == TRUE) {
...
if(RAMP == TRUE) {
 ...
 ##FOLLOW UP A
##confirm number of rows in current dataset (= 50503)
...
##confirm number of rows in dataset after filtering (should be 50503 - 14,717)
nrow(dat.raw.taf.ramp)
}
```
...
dat.raw.taf.ramp <- dat.raw.taf.ramp %>%
  select(ID,
         `taf.worth_living_life_people_.Wave 0`,
         `taf.worth_living_life_people_.Wave 1`,
         `taf.worth_living_life_people_.Wave 2`,
         `taf.worth_living_life_people_.Wave 3`,
         `taf.worth_living_life_people_.Wave 4`,
         ...
         `taf.felt_weeks_past_.Wave 0`,
         `taf.felt_weeks_past_.Wave 1`,
         `taf.felt_weeks_past_.Wave 2`,
         `taf.felt_weeks_past_.Wave 3`,
         `taf.felt_weeks_past_.Wave 4`,
         `taf.felt_weeks_past_.Wave 5`,
         `taf.felt_weeks_past_.Wave 6`,
         `taf.felt_weeks_past_.Wave 7`,
         `taf.felt_weeks_past_.Wave 8`,
        
         `taf.have_you_contemplated_harming_yourself_.Wave 0`,
         `taf.have_you_contemplated_harming_yourself_.Wave 1`,
         `taf.have_you_contemplated_harming_yourself_.Wave 2`,
         `taf.have_you_contemplated_harming_yourself_.Wave 3`,
         `taf.have_you_contemplated_harming_yourself_.Wave 4`,
         ...
         `taf.felt_weeks_past.1_.Wave 0`,
         `taf.felt_weeks_past.1_.Wave 1`,
         `taf.felt_weeks_past.1_.Wave 2`,
         `taf.felt_weeks_past.1_.Wave 3`,
         `taf.felt_weeks_past.1_.Wave 4`,
         `taf.felt_weeks_past.1_.Wave 5`,
         `taf.felt_weeks_past.1_.Wave 6`,
         `taf.felt_weeks_past.1_.Wave 7`,
         `taf.felt_weeks_past.1_.Wave 8`,
        
         `taf.meant_life_end_weeks_.Wave 0`,
         `taf.meant_life_end_weeks_.Wave 1`,
         `taf.meant_life_end_weeks_.Wave 2`,
         `taf.meant_life_end_weeks_.Wave 3`,
         `taf.meant_life_end_weeks_.Wave 4`,
...
##FIRST - checking for number of entries per wave!
...
### CHECKING DUPS IN BASELINE ### i.e., seeeing if two people have been assigned the same ID
```{r}
edeq.ramp.baseline.raw %>%
...
edeq.ramp.baseline.raw %>%
  filter(`Login ID` == "b9cb44638fc728f7ade0b43419bd")

edeq.ramp.baseline.raw %>%
  filter(`Login ID` == "5842dd2523474a35f849d7105152")

edeq.ramp.baseline.raw %>%
  filter(`Login ID` == "b9cb44638fc728f7ade0b43419bd")

edeq.ramp.baseline.raw %>%
  filter(`Login ID` == "fc97d7705ab0ec4bf95fa3eea814")


edeq.ramp.baseline.raw %>%
  filter(`Login ID` == "0f0965788de87a3fad79aba14085")
...
edeq.ramp.baseline.raw %>%
  filter(`Login ID` == "1a47ff6555d71515aa20484e59c4")

edeq.ramp.baseline.raw %>%
  filter(`Login ID` == "2d6f692405cebd783448d2d3bcdd")

edeq.ramp.baseline.raw %>%
  filter(`Login ID` == "5842dd2523474a35f849d7105152")

edeq.ramp.baseline.raw %>%
  filter(`Login ID` == "58f9100b53025dbe08d6ee148502") #ONLY ONE
	

edeq.ramp.baseline.raw %>%
  filter(`Login ID` == "7023d347374e2fdd77ea1270c3fe") #ONLY ONE

edeq.ramp.baseline.raw %>%
  filter(`Login ID` == "b5e2e62f0a2c261807caa1ac90b5")
...
edeq.ramp.followupb.screener.raw.id <- edeq.ramp.followupb.screener.raw.id  %>%
  select(ID,
         `ed_scid5.regular_episodes_eating_binges_.Wave 1`,
         `ed_scid5.regular_episodes_eating_binges_.Wave 2` ,    
         `ed_scid5.regular_episodes_eating_binges_.Wave 3` ,       
         `ed_scid5.regular_episodes_eating_binges_.Wave 4`,
         `ed_scid5.regular_episodes_eating_binges_.Wave 5`,
         `ed_scid5.regular_episodes_eating_binges_.Wave 6`,
         `ed_scid5.regular_episodes_eating_binges_.Wave 7`,
         `ed_scid5.regular_episodes_eating_binges_.Wave 8`,
         
         `ed_scid5.weigh_weighed_past_month_.Wave 1` , 
         `ed_scid5.weigh_weighed_past_month_.Wave 2` ,             
         `ed_scid5.weigh_weighed_past_month_.Wave 3`,               
         `ed_scid5.weigh_weighed_past_month_.Wave 4` ,             
         `ed_scid5.weigh_weighed_past_month_.Wave 5`,
         `ed_scid5.weigh_weighed_past_month_.Wave 6`,
         `ed_scid5.weigh_weighed_past_month_.Wave 7`,
         `ed_scid5.weigh_weighed_past_month_.Wave 8`,
         
         `ed_scid5.regular_episodes_eating_binges_numeric_.Wave 1`,
         `ed_scid5.regular_episodes_eating_binges_numeric_.Wave 2`,
         `ed_scid5.regular_episodes_eating_binges_numeric_.Wave 3`,
         `ed_scid5.regular_episodes_eating_binges_numeric_.Wave 4`,
         `ed_scid5.regular_episodes_eating_binges_numeric_.Wave 5`, 
         `ed_scid5.regular_episodes_eating_binges_numeric_.Wave 6`,  
         `ed_scid5.regular_episodes_eating_binges_numeric_.Wave 7`,  
         `ed_scid5.regular_episodes_eating_binges_numeric_.Wave 8`, 
         
         `ed_scid5.weigh_weighed_past_month_numeric_.Wave 1`,
         `ed_scid5.weigh_weighed_past_month_numeric_.Wave 2`,
         `ed_scid5.weigh_weighed_past_month_numeric_.Wave 3`,
         `ed_scid5.weigh_weighed_past_month_numeric_.Wave 4`,
         `ed_scid5.weigh_weighed_past_month_numeric_.Wave 5`,
         `ed_scid5.weigh_weighed_past_month_numeric_.Wave 6`,
         `ed_scid5.weigh_weighed_past_month_numeric_.Wave 7`,
...
## 3. Change follow up TAF COPING to wide format
```{r TAF COPING long format}
if(COPING == TRUE) {
dat.raw.taf.coping.long <- dat.raw.taf.coping %>%
  group_by(wave_taf) %>%
  mutate(row = row_number()) %>%
  tidyr::pivot_wider(id_cols = ID,
                     names_from = wave_taf,
...
##Remove dup IDs from early waves (were every two weeks - should take later entry) ***HLD


##4. Select variables for dataset TAF COPING
```{r}
if(COPING == TRUE) {
dat.raw.taf.coping <- dat.raw.taf.coping.long %>%
  select(ID,
          `taf.worth_living_life_people_.Wave 1`,
         `taf.worth_living_life_people_.Wave 2`,
         `taf.worth_living_life_people_.Wave 3`,
         ...
         `taf.worth_living_life_people_.Wave 7`,
         `taf.worth_living_life_people_.Wave 8`,
         `taf.worth_living_life_people_.Wave 9`,
         ...
         `taf.have_you_contemplated_harming_yourself_.Wave 7`,
         `taf.have_you_contemplated_harming_yourself_.Wave 8`,
         `taf.have_you_contemplated_harming_yourself_.Wave 9`,
         ...
         `taf.meant_life_end_weeks_.Wave 7`,
         `taf.meant_life_end_weeks_.Wave 8`,
         `taf.meant_life_end_weeks_.Wave 9`)
}
```
...
##5. Remove duplicate IDs EDEQ COPING
```{r}
if(COPING == TRUE) {
##Check col names
colnames(edeq.coping.followupb.raw.id)
...
edgi.4 <- taf.edgi.coping.baseline.CUTOFF.raw.id %>% #590
  select(ID,
  cohort_name,
...
edgi.6 <- taf.edgi.coping.baseline.raw.id %>% #590
  select(ID,
  cohort_name,
...
glad.4 <- taf.glad.coping.baseline.CUTOFF.raw.id%>%
  select(ID,
  cohort_name,
  taf.worth_living_life_people_.Wavebaseline,
  taf.felt_weeks_past_.Wavebaseline,
...
glad.6 <- taf.glad.coping.baseline.raw.id  %>%
  select(ID,
  cohort_name,
  taf.pandemic_felt_.Wavebaseline,
  taf.pandemic_felt.1_.Wavebaseline,
...
nbr.4 <- taf.nbr.baseline.CUTOFF.raw.id %>%
  select(ID,
  cohort_name,
  taf.worth_living_life_people_.Wavebaseline,
  taf.felt_weeks_past_.Wavebaseline,
...
if(RAMP == TRUE) {
  ...
  ramp.3 <- edeq.ramp.baseline.raw.id %>% #retro prepan
  select(ID,
  cohort_name,
...
ramp.5 <- taf.ramp.baseline.CUTOFF.raw.id  %>% #for baseline cut off at 30th April
  select(ID,
         cohort_name,
         taf.worth_living_life_people_.Wavebaseline,
  taf.felt_weeks_past_.Wavebaseline,
...
ramp.7 <- edeq.ramp.baseline.CUTOFF.raw.id %>% #Baseline BEFORE 30th April
  select(ID,
  cohort_name,
