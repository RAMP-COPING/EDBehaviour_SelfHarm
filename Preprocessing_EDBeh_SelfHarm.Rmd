...
edgi.6 <- taf.edgi.coping.baseline.CUTOFF.raw.id %>% #590
  select(ID,
  cohort_name,
...
glad.6 <- taf.glad.coping.baseline.CUTOFF.raw.id %>%
  select(ID,
  cohort_name,
  taf.pandemic_felt_.Wavebaseline,
  taf.pandemic_felt.1_.Wavebaseline,
...
nbr.6 <- taf.nbr.baseline.CUTOFF.raw.id %>% 
  select(ID,
  cohort_name,
  taf.pandemic_felt_.Wavebaseline,
  taf.pandemic_felt.1_.Wavebaseline,
...
ramp.5 <- taf.ramp.baseline.raw.id %>% #for retro prepan
  select(ID,
         cohort_name,
         taf.worth_living_life_people_.Wavebaseline,
  taf.felt_weeks_past_.Wavebaseline,
...
ramp.6 <- taf.ramp.baseline.CUTOFF.raw.id %>% #for baseline cut off at 30th April
  select(ID,
  cohort_name,
  taf.pandemic_felt_.Wavebaseline,
  taf.pandemic_felt.1_.Wavebaseline,
