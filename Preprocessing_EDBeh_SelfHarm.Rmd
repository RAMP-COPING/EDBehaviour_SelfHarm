...
##Exclude people who answered baseline questionnaire after 21st April (earliest follow up questionnaire filled out 21st April)
...
#Filter by people who completed baseline survey before 21st april
...
ramp.6 <- taf.ramp.baseline.CUTOFF.raw.id %>% #for baseline cut off at 21st April
  select(ID,
  cohort_name,
  taf.pandemic_felt_.Wavebaseline,
  taf.pandemic_felt.1_.Wavebaseline,
...
ramp.7 <- edeq.ramp.baseline.CUTOFF.raw.id %>% #Baseline BEFORE 21st April
  select(ID,
  cohort_name,
