---
title: "Sensitivity analysis: Excluding GLAD and EDGI"
...
# Exclude EDGI and GLAD
```{r exclude EDGI and GLAD}
dat <- dat %>%
  filter(sample == "NBR" |
           sample == "RAMP")
```
...
ggsave(
  ...
  device = "png", 
  path = paste0(filepath_plots_sensitivity_excl_EDGI_GLAD), 
  scale = 1,
  width = 25,
  height = 25,
  units = "cm"
...
ggsave(
  ...
  device = "jpeg", 
  path = filepath_plots_sensitivity_excl_EDGI_GLAD, 
  scale = 1,
  width = 50,
  height = 20,
  units = "cm"
