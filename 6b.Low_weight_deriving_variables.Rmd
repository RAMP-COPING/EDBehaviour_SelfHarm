...
dat %>%
  ...
  select(starts_with("ed_scid5.weigh_weighed_past_month_."))
```
...
```
121 people endorsed a positive COVID test/being unwell with COVID in a phase after the phase in which they endorsed experiencing low weight.
