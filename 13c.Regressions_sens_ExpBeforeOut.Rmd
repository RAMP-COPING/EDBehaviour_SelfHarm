...
# Read in data
```{r Read in data}
dat <- readRDS(file = "../data_cleaned/sens_dat_no_baseline2022-06-21.rds")
dim(dat)
   colnames(dat)
```
...
dat %>%
  ...
  freq(sens2_NEW_binge_eating_pandemic)
...
dat %>%
  ...
  freq(sens2_NEW_low_weight_pandemic)
...
model2 <- glm(sens2_NEW_low_weight_pandemic ~ 
                 age_category_COVID_baseline +
                 sex_binary +
                 minoritised_gender +
                 race_binary +
...
model3 <- glm(sens2_NEW_harmful_ideation_pandemic ~ 
                 age_category_COVID_baseline + 
                 sex_binary +
                 minoritised_gender + 
                 race_binary + 
...
model4 <- glm(sens2_NEW_selfharm_pandemic ~ 
                 age_category_COVID_baseline + 
                 sex_binary +
                 minoritised_gender + 
                 race_binary + 
