...
ED.cc$ed.height_current_metres <- 
  if_else(
    condition = is.na(ED.cc$ed.height_current_metres),
    true = (ED.cc$ed.height_ft*0.3048) + (ED.cc$ed.height_in*0.0254),
    false = NA_real_,
    missing = NA_real_
    )
...
ED.cc$ed.height_current_metres <- 
  if_else(
    condition = is.na(ED.cc$ed.height_current_metres),
    true = ED.cc$ed.height_cm/100,
    false = ED.cc$ed.height_current_metres)

# Summary
summary(ED.cc$ed.height_current_metres)
```
