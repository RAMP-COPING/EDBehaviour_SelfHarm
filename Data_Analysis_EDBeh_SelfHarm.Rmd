...
edeq.felt_anxious_blue_bored.3_baseline (retro prepan)
...
edeq.weight_influenced_person.1 (retro prepan)
edeq.weight_influenced_person_X (baseline and waves)
...
##Rename variable names in EDEQ
```{r}
dat.taf <- dat.taf %>% 
  rename(
    edeq.sick_means_made_shape.1_baseline = edeq.sick_means_made_shape.retroprepan,
