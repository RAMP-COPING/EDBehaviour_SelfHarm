...
```{r}
freq(dat.taf$depressive_disorders_numeric) ##ALL GLAD

z <- dat.taf %>% 
  filter(depressive_disorders_numeric ==1)

freq(z$anxiety_disorders_numeric) #
...
freq(dat.taf$obsessive_compulsive_disorders_numeric) ##all glad
...
freq(dat.taf$mhd.personality_disorder_numeric)

z <- dat.taf %>%
  filter(mhd.personality_disorder_numeric == 1)
