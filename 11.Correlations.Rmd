...
BE_dat_corr_mat <- dat_dummy %>%
  select(
   ...
   "Minoritised gender" = "gender_cleaned_Minoritised gender",
   ...
   "No qualifications" = "highest_education_No formal qualifications",                    
   "GCSE/CSE" =  "highest_education_GCSE/CSE",                                    
   "NVQ" =  "highest_education_NVQ",                                        
   "A-Levels" =   "highest_education_A-levels",                                    
   "Uni/Other prof qual" = "highest_education_University/Other professional qualifications",
   ...
   "Pandemic worry score" = "panworry_total_score"
 ) 

# Run correlation analyses with continious and dichotomous variables 
BE_corr_mat_object <- psych::mixedCor(data=BE_dat_corr_mat,
         c= 28,  # Continuous variables
         p= NULL,
         d= 1:27, # Dichotomous variable
             use="pairwise.complete.obs")
...
LW_dat_corr_mat <- dat_dummy %>%
  select(
   ...
   "Compulsive beh/mental act" = "ocd.compulsive_beh_mental_act_binary_Yes",
   "Repetitive thoughts" =  "ocd.repetitive_unpleasant_thoughts_binary_Yes",
   "Pandemic worry score" = "panworry_total_score"
...
png(height = 900,
    width = 900,
    file = paste0(filepath_plots_corr, "merged_ocd_LW_exposures_corr_matrix.png")
)
