...
```{r Read in dataset}
# Exposures
dat_exposures <- readRDS(paste0(filepath_saved_data, "exposures_all_models2022-04-28.rds"))

# Outcome: Binge eating (& outcome-specific exposure variables)
dat_BE <- readRDS(paste0(filepath_saved_data, "final_dat_BE2022-04-28.rds"))

# Outcome:Low weight (& outcome-specific exposure variables)
dat_LW <- readRDS(paste0(filepath_saved_data, "final_dat_LW2022-04-28.rds"))

# Outcome:Harmful ideation (& outcome-specific exposure variables)
dat_HI <- readRDS(paste0(filepath_saved_data, "final_dat_HI2022-04-28.rds"))

# Outcome: Self-harm (& outcome-specific exposure variables)
dat_SH <- readRDS(paste0(filepath_saved_data, "final_dat_SH2022-04-28.rds"))
```
