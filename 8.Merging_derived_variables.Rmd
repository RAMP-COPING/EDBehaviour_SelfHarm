...
```{r Read in dataset}
# Binge eating
dat_BE <- readRDS("/Users/helenadavies/werk/EDBEHSELFHARM2/gitEDBEHSELFHARM/data_cleaned/final_dat_BE2022-03-24.rds")

# Low weight
dat_LW <- readRDS("/Users/helenadavies/werk/EDBEHSELFHARM2/gitEDBEHSELFHARM/data_cleaned/final_dat_LW2022-03-24.rds")

# Harmful ideation
dat_HI <- readRDS("/Users/helenadavies/werk/EDBEHSELFHARM2/gitEDBEHSELFHARM/data_cleaned/final_dat_HI2022-03-24.rds")

# Self-harm
dat_SH <- readRDS("/Users/helenadavies/werk/EDBEHSELFHARM2/gitEDBEHSELFHARM/data_cleaned/final_dat_SH2022-03-24.rds")
```
