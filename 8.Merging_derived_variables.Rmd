...
```{r Read in dataset}
# Exposures
dat_exposures <- readRDS(paste0(filepath_saved_data, "exposures_all_models2022-09-23.rds"))

# Outcome: Binge eating (& outcome-specific exposure variables)
dat_BE <- readRDS(paste0(filepath_saved_data, "final_dat_BE2022-09-24.rds"))

# Outcome:Low weight (& outcome-specific exposure variables)
dat_LW <- readRDS(paste0(filepath_saved_data, "final_dat_LW2022-09-24.rds"))
