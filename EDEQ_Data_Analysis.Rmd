...
dat.edeq <- dat.edeq %>% 
  rename(
    edeq.sick_means_made_shape_.Waveretro_prepan = edeq.sick_means_made_shape.1_.Wavebaseline_numeric,
    edeq.felt_anxious_blue_bored.3_.Waveretro_prepan = edeq.felt_anxious_blue_bored.3_.Wavebaseline,
    edeq.diuretics_laxatives_means_shape.1_.Waveretro_prepan= edeq.diuretics_laxatives_means_shape.1_.Wavebaseline_numeric,
    edeq.compulsive_driven_burn_calories.1_.Waveretro_prepan = edeq.compulsive_driven_burn_calories.1_.Wavebaseline_numeric,
    edeq.nibbled_picked_snacks_grazed.1_.Waveretro_prepan = edeq.nibbled_picked_snacks_grazed.1_.Wavebaseline,
    edeq.felt_anxious_blue_bored.2_.Waveretro_prepan = edeq.felt_anxious_blue_bored.2_.Wavebaseline,
    edeq.regard_lost_control_eaten.1_.Waveretro_prepan = edeq.regard_lost_control_eaten.1_.Wavebaseline_numeric,
    
    
    edeq.calories_made_body_shape.1_.Waveretro_prepan = edeq.calories_made_body_shape.1_.Wavebaseline,
    edeq.weight_influenced_person.1_.Waveretro_prepan = edeq.weight_influenced_person.1_.Wavebaseline,
    edeq.dissatisfied_shape_weight.1_.Waveretro_prepan = edeq.dissatisfied_shape_weight.1_.Wavebaseline,
    edeq.actively_been_monitoring_your_shape_or_weight_.Waveretro_prepan = edeq.actively_been_monitoring_your_shape_or_weight_.1_.Wavebaseline_numeric,
    edeq.eating_behaviours_concerns_distressed_.Waveretro_prepan = edeq.eating_behaviours_concerns_distressed.1_.Wavebaseline
