...
dat.edeq.screener <- dat.edeq %>%
  filter(
    !is.na(`ed_scid5.regular_episodes_eating_binges_.Wave 1b`) |
      !is.na(`ed_scid5.regular_episodes_eating_binges_.Wave 2b`) |
      !is.na(`ed_scid5.regular_episodes_eating_binges_.Wave 3b`) |
      !is.na(`ed_scid5.regular_episodes_eating_binges_.Wave 4b`) |
      !is.na(`ed_scid5.regular_episodes_eating_binges_.Wave 6`) |
      !is.na(`ed_scid5.regular_episodes_eating_binges_.Wave 8`) |
      !is.na(`ed_scid5.weigh_weighed_past_month_.Wave 1b`) |
      !is.na(`ed_scid5.weigh_weighed_past_month_.Wave 2b`) |
      !is.na(`ed_scid5.weigh_weighed_past_month_.Wave 3b`) |
      !is.na(`ed_scid5.weigh_weighed_past_month_.Wave 4b`) |
      !is.na(`ed_scid5.weigh_weighed_past_month_.Wave 6`) |
      !is.na(`ed_scid5.weigh_weighed_past_month_.Wave 8`) |
      !is.na(`ed_scid5.regular_episodes_eating_binges_numeric_.Wave 1b`) |
      !is.na(`ed_scid5.regular_episodes_eating_binges_numeric_.Wave 2b`) |
      !is.na(`ed_scid5.regular_episodes_eating_binges_numeric_.Wave 1b`) |
      !is.na(`ed_scid5.regular_episodes_eating_binges_numeric_.Wave 2b`) |
      !is.na(`ed_scid5.regular_episodes_eating_binges_numeric_.Wave 3b`) |
      !is.na(`ed_scid5.regular_episodes_eating_binges_numeric_.Wave 4b`) |
      ...
      !is.na(`ed_scid5.weigh_weighed_past_month_numeric_.Wave 1b`) |
      !is.na(`ed_scid5.weigh_weighed_past_month_numeric_.Wave 2b`) |
      !is.na(`ed_scid5.weigh_weighed_past_month_numeric_.Wave 3b`) |
      !is.na(`ed_scid5.weigh_weighed_past_month_numeric_.Wave 4b`) |
...
```{r}
##Filter out those with ALL missing data in screener dataset
'%!in%' <- function(x,y)!('%in%'(x,y))

dat.edeq.screener.id <- dat.edeq %>%
  filter(ID %!in% dat.edeq.screener$ID)

nrow(dat.edeq.screener.id) ##TOTAL == 
...
freq(dat.edeq$edeq.actively_been_monitoring_your_shape_or_weight_numeric_.Wavebaseline)
...
table(dat.edeq.1b$wave)


dat.edeq.2b <- dat.edeq %>%
  filter(wave == " 2b" &
           (!is.na(edeq.deliberately_limit_amount_influence) |
           !is.na(edeq.calories_made_body_shape) |
           !is.na(edeq.weight_influenced_person) |
...
table(dat.edeq.2b$wave)

dat.edeq.3b <- dat.edeq %>%
  filter(wave == " 3b" &
           (!is.na(edeq.deliberately_limit_amount_influence) |
           !is.na(edeq.calories_made_body_shape) |
           !is.na(edeq.weight_influenced_person) |
...
levels(dat.no.nas$wave_factor)[2] <- "Baseline: 7th April - 20th April (2020)"

levels(dat.no.nas$wave_factor)[3] <- "6th May - 19th May (2020)" 

levels(dat.no.nas$wave_factor)[4] <- "3rd June - 16th June (2020)"

levels(dat.no.nas$wave_factor)[5] <- "31st June - 14th July (2020)"

levels(dat.no.nas$wave_factor)[6] <- "29th July - 25th August (2020)"

levels(dat.no.nas$wave_factor)[7] <- "23rd September - 20th October (2020)"

levels(dat.no.nas$wave_factor)[8] <- "18th November - 15th December (2020)"
