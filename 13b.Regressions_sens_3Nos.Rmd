...
BE_sens_3_nos_dat_plot <- dat_plot %>%
  finalfit::or_plot(dependent,
          ...
          table_text_size = 3.5,
          title_text_size = 15,
          dependent_label = "Sensitivity analysis (3 No's): New onset binge eating during pandemic",
          remove_ref = FALSE) 
```
...
model2 <- glm(sens_NEW_low_weight_pandemic ~ age_category_COVID_baseline +
                 gender_cleaned +
                 race_binary +
                 highest_education +
                 psych_disorder_factor +
...
LW_sens_3_nos_dat_plot <- dat_plot %>%
  finalfit::or_plot(dependent,
          ...
          table_text_size = 3.5,
          title_text_size = 15,
          dependent_label = "Sensitivity analysis (3 No's): New onset low weight during pandemic",
          remove_ref = FALSE) 
```
...
HI_sens_3_nos_dat_plot <- dat_plot %>%
  finalfit::or_plot(dependent, explanatory, 
          breaks = c(0.5, 1, 5, 10, 20, 30),
           table_text_size = 3.5,
          title_text_size = 13,
          dependent_label = "Sensitivity analysis (3 No's): New onset suicidal and/or self-harm ideation during pandemic",
           remove_ref = FALSE) 
```
...
SH_sens_3_nos_dat_plot <- dat_plot %>%
  finalfit::or_plot(dependent, explanatory, 
          ...
          table_text_size = 3.5,
          title_text_size = 13,
          dependent_label = "Sensitivity analysis (3 No's): New onset self-harm during pandemic",
          remove_ref = FALSE)
```
...
low_weight_joined[9,1] <- "Racially minoritised (vs. white)"
...
low_weight_joined[12,1] <- "Highest education: A-levels (vs. no formal education)"
low_weight_joined[13,1] <- "Highest education: Uni/Other professional quals (vs. no formal education)"
low_weight_joined[14,1] <- "Psychiatric disorder (vs. not)"
low_weight_joined[15,1] <- "Key worker (vs. paid employment)"
low_weight_joined[16,1] <- "Not in paid employment (vs. paid employment)"
low_weight_joined[17,1] <- "Retired (vs. paid employment)"
low_weight_joined[18,1] <- "Student (vs. paid employment)"
low_weight_joined[19,1] <- "Vulnerable group member (vs. not)"
low_weight_joined[20,1] <- "Pandemic worry total score"
low_weight_joined[21,1] <- "COVID-19 infection (vs. not)"
low_weight_joined[22,1] <- "Lost someone due to COVID-19 (vs. not)"
low_weight_joined[23,1] <- "Change in main economic activity (vs. not)"
low_weight_joined[24,1] <- "Change in living situation (vs. not)"
low_weight_joined[25,1] <- "OCD symptoms"
