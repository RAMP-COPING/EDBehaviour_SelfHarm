...
```{r Binge eating sens_3_nos model}
model1 <- glm(sens_NEW_binge_eating_pandemic ~  
...
Plot
```{r Binge eating sens_3_nos model plot}
dat_plot <- dat %>%
  select("Age" = "age_category_COVID_baseline",
         "Sex"= "sex_binary",
         "Minoritised_gender" = "minoritised_gender",
         "Race" = "race_binary",
         "New_onset_binge_eating" = "sens_NEW_binge_eating_pandemic",
...
BE_sens_3_nos_dat_plot <- dat_plot %>%
  finalfit::or_plot(dependent,
                    explanatory, 
          breaks = c(0.5, 1, 5, 10, 20, 30),
          table_text_size = 3.5,
          title_text_size = 15,
          dependent_label = "Sensitivity analysis (3 nos): New onset binge eating during pandemic",
          remove_ref = FALSE,
...
```{r Save BE sens_3_nos level plot}
ggsave(
  paste0("BE_sens_3_nos_dat_plot",
                    date,
                    ".png"),
  plot = BE_sens_3_nos_dat_plot,
  device = "png", 
...
# Low weight 
Age, gender, race, education, psych disorder, key worker/employment status, vulnerable group member, pandemic worry, positive COVID test, loss of loved one, change in main eco activity, change in living situation
```{r Low weight sens_3_nos model}
model2 <- glm(sens_NEW_low_weight_pandemic ~ 
                 age_category_COVID_baseline +
                 sex_binary +
                 minoritised_gender +
                 race_binary +
...
Plot
```{r Low weight sens_3_nos model plot}
dat_plot <- dat %>%
  select("Age" = "age_category_COVID_baseline",
         "Sex" = "sex_binary",
         "Minoritised_gender" = "minoritised_gender",
         "Race" = "race_binary",
         "New_onset_low_weight" = "sens_NEW_low_weight_pandemic",
         "Psychiatric_disorder" = "psych_disorder_factor",
         "Employment_status" = "paid_employment_key_worker",
         "Vulnerable_group_member" ="vulnerable_group_member",
         "Pandemic_worry_score" = "panworry_factor",
...
LW_sens_3_nos_dat_plot <- dat_plot %>%
  finalfit::or_plot(dependent,
                    explanatory, 
          breaks = c(0.5, 1, 5, 10, 20, 30),
          table_text_size = 3.5,
          title_text_size = 15,
          dependent_label = "Sensitivity analysis (3 nos): New onset low weight during pandemic",
          remove_ref = FALSE,
          plot_opts=list(geom_point(aes(size = Total), shape=22, fill="white"),
                   geom_errorbarh(height=0.2)
    )
...
```{r Save LW sens_3_nos level plot}
ggsave(
  paste0("LW_sens_3_nos_dat_plot",
                    date,
                    ".png"),
  plot = LW_sens_3_nos_dat_plot,
  device = "png", 
  path = paste0(filepath_plots_sensitivity_three_nos), 
   scale = 1,
  width = 25,
...
Age, gender, race, education, psych disorder, key worker/employment status, vulnerable group member, pandemic worry, positive COVID test, loss of loved one, change in main eco activity, change in living situation
```{r Harmful ideation sens_3_nos model}
model3 <- glm(sens_NEW_harmful_ideation_pandemic ~ age_category_COVID_baseline + 
                sex_binary +
                 minoritised_gender + 
                 race_binary + 
                 psych_disorder_factor + 
...
harmful_ideation_sens <- tidy(model3,
     conf.int=TRUE,
     exponentiate=TRUE)
...
Plot
```{r Harmful ideation sens_3_nos model plot}
dat_plot <- dat %>%
  select("Age" = "age_category_COVID_baseline",
         "Sex" = "sex_binary",
         "Minoritised_gender" = "minoritised_gender",
         "Race" = "race_binary",
         "New_onset_suicidal_selfharm_ideation" = "sens_NEW_harmful_ideation_pandemic",
         "Psychiatric_disorder" = "psych_disorder_factor",
         "Employment_status" = "paid_employment_key_worker",
         "Vulnerable_group_member" ="vulnerable_group_member",
         "Pandemic_worry_score" = "panworry_factor",
...
HI_sens_3_nos_dat_plot <- dat_plot %>%
  finalfit::or_plot(dependent, explanatory, 
          breaks = c(0.5, 1, 5, 10, 20, 30),
           table_text_size = 3.5,
          title_text_size = 13,
          dependent_label = "Sensitivity analysis (3 nos): New onset suicidal and/or self-harm ideation during pandemic",
           remove_ref = FALSE,
          plot_opts=list(geom_point(aes(size = Total), shape=22, fill="white"),
                   geom_errorbarh(height=0.2)
    )
...
```{r Save HI sens_3_nos level plot}
ggsave(
  paste0("HI_sens_3_nos_dat_plot",
                    date,
                    ".png"),
  plot = HI_sens_3_nos_dat_plot,
  device = "png", 
  path = paste0(filepath_plots_sensitivity_three_nos), 
  scale = 1,
  width = 25,
...
# Self-harm
Age, gender, race, education, psych disorder, key worker/employment status, vulnerable group member, pandemic worry, positive COVID test, loss of loved one, change in main eco activity, change in living situation
```{r Self-harm sens_3_nos model}
model4 <- glm(sens_NEW_selfharm_pandemic ~ age_category_COVID_baseline + 
                sex_binary +
                 minoritised_gender + 
                 race_binary + 
                 psych_disorder_factor + 
...
Plot 
```{r Self-harm sens_3_nos model plot}
dat_plot <- dat %>%
  select("Age" = "age_category_COVID_baseline",
         "Sex" = "sex_binary",
         "Minoritised_gender" = "minoritised_gender",
         "Race" = "race_binary",
         "New_onset_selfharm" = "sens_NEW_selfharm_pandemic",
         "Psychiatric_disorder" = "psych_disorder_factor",
         "Employment_status" = "paid_employment_key_worker",
         "Vulnerable_group_member" ="vulnerable_group_member",
         "Pandemic_worry_score" = "panworry_factor",
...
SH_sens_3_nos_dat_plot <- dat_plot %>%
  finalfit::or_plot(dependent, explanatory, 
          breaks = c(0.5, 1, 5, 10, 20, 30),
          table_text_size = 3.5,
          title_text_size = 13,
          dependent_label = "Sensitivity analysis (3 nos): New onset self-harm during pandemic",
          remove_ref = FALSE,
          plot_opts=list(geom_point(aes(size = Total), shape=22, fill="white"),
                   geom_errorbarh(height=0.2)
    )
...
```{r Save SH sens_3_nos level plot}
ggsave(
  paste0("SH_sens_3_nos_dat_plot",
                    date,
                    ".png"),
  plot = SH_sens_3_nos_dat_plot,
  device = "png", 
  path = paste0(filepath_plots_sensitivity_three_nos), 
  scale = 1,
  width = 25,
...
cor_ORs_low_weight_3nos <- ggplot(data = low_weight_joined,
  ...
  ggplot2::labs(
    y = "OR main analysis",
    x = "OR sensitivity analysis: Three nos",
...
ggsave(
  ...
  device = "jpeg", 
  path = filepath_plots_sensitivity_three_nos, 
  scale = 1,
  width = 50,
  height = 20,
  units = "cm"
