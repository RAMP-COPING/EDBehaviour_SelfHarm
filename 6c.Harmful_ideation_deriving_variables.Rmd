...
dat %>%
  ...
  select(starts_with("taf.felt_weeks_past_"))
```
...
dat %>%
  ...
  select(starts_with("taf.worth_living_life_people_."))
```
...
dat %>%
  freq(NEW_passive_suicidal_ideation_pandemic) # NAs are because the sample is restricted to those who did NOT report suicidal ideation at baseline
...
dat %>%
  ...
  select(starts_with("taf.felt_weeks_past.1_"))
```
...
dat %>%
  ...
  select(starts_with("taf.have_you_contemplated_harming_yourself_."))
...
dat <- dat %>%
  mutate(NEW_harmful_ideation_pandemic =
           case_when(
             # Didn't experience either prepandemic, and went on to experience one during the pandemic
             ((PREPANDEMIC_passive_suicidal_ideation == 0 &
               PREPANDEMIC_selfharm_ideation == 0) &
             (NEW_selfharm_ideation_pandemic == 1 |
             NEW_passive_suicidal_ideation_pandemic == 1) ~ 1),
             
             # Didn't experience either prepandemic, and did not experience either during the pandemic
              ((PREPANDEMIC_passive_suicidal_ideation == 0 &
               PREPANDEMIC_selfharm_ideation == 0) &
...
dat %>% 
  ...
  select(PREPANDEMIC_passive_suicidal_ideation,
    TWO_WEEKS_PANDEMIC_passive_suicidal_ideation,
    EVER_PANDEMIC_passive_suicidal_ideation,
    NEW_passive_suicidal_ideation_pandemic) # Some people missing have a 0 for one but are NA for the other. Can not assume they have not experienced some form of harmful ideation so have to drop from this variable. 


# Check self-harm ideation
dat %>% 
  filter(is.na(NEW_harmful_ideation_pandemic) &
          !is.na(NEW_selfharm_ideation_pandemic)
         ) %>%
  select(PREPANDEMIC_selfharm_ideation,
    TWO_WEEKS_PANDEMIC_selfharm_ideation,
    EVER_PANDEMIC_selfharm_ideation,
...
dat %>%
  filter(is.na(NEW_harmful_ideation_pandemic) &
    ...
    nrow()
# 0 people are missing for harmful ideation and have a value for both self-harm ideation and suicidal ideation



# 4,854 people experienced prepan suicidal ideation (therefore can NOT have had new onset)...
dat %>%
  filter(is.na(NEW_harmful_ideation_pandemic) &
          !is.na(NEW_selfharm_ideation_pandemic) &
           is.na(NEW_passive_suicidal_ideation_pandemic)
...
# ...but these people did not experience prepan self-harm ideation or new onset during the pandemic
dat %>%
  filter(is.na(NEW_harmful_ideation_pandemic) &
          !is.na(NEW_selfharm_ideation_pandemic) &
           is.na(NEW_passive_suicidal_ideation_pandemic) 
...
# 1,418 people experienced prepan self-harm ideation (therefore can NOT have had new onset)...
dat %>%
  filter(is.na(NEW_harmful_ideation_pandemic) &
          is.na(NEW_selfharm_ideation_pandemic) &
          ! is.na(NEW_passive_suicidal_ideation_pandemic)
...
# ...but these people did not experience prepan suicidal ideation or new onset during the pandemic
dat %>%
  filter(is.na(NEW_harmful_ideation_pandemic) &
          is.na(NEW_selfharm_ideation_pandemic) &
          ! is.na(NEW_passive_suicidal_ideation_pandemic) 
...
dat %>%
  filter(outcome_phase_harmful_ideation == "Not answered or PNTA" &
            !is.na(NEW_selfharm_ideation_pandemic) &
         !is.na(NEW_passive_suicidal_ideation_pandemic)
  )
```
  ...
  mutate(positive_covid_test_HI_9a =
           case_when(exposure_phase_positive_covid_test == "9a" &
                    ...
                    outcome_phase_harmful_ideation == "Not experienced" ~ "No outcome",  # Never experienced outcome (people who are all NA are coded as "Not answered")
                     ...
                     exposure_phase_positive_covid_test == "9a" & # First positive COVID test at phase 9a
                    (outcome_phase_harmful_ideation == "9a" | # Co-occurring exposure & outcome
                      outcome_phase_harmful_ideation == "10b" |
                       outcome_phase_harmful_ideation == "11a" | 
                     outcome_phase_harmful_ideation == "12b"|
                         outcome_phase_harmful_ideation == "13a" |
  ...
  mutate(positive_covid_test_before_HI =
           case_when(# First positive test NOT before first experience of harm ideation
              ...
              positive_covid_test_HI_11a == "To drop" |
                ...
                # First positive test BEFORE first experience of passive suicidal ideation
...
```
343 people endorsed harmful ideation in a phase before the phase in which they endorsed a positive COVID test/being unwell with COVID.
...
```
324 people reported harmful ideation in a phase before the phase in which they reported losing someone.
...
dat <- dat %>%
  mutate(main_eco_change_HI_7a =
           case_when(exposure_phase_main_eco_change == "7a" &
                     ...
                     outcome_phase_harmful_ideation == "4b" |
                       outcome_phase_harmful_ideation == "5a" |
                       outcome_phase_harmful_ideation == "6b")  ~ "To drop", # First experience of outcome occurred before first experience of exposure
...
```
215 people reported harmful ideation in a phase before the phase in which they reported a change in their main economic activity.
...
```
285 people reported experiencing harmful ideation in a phase before the phase in which they reported a change in their living situation.
