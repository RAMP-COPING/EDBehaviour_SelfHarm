...
Want to control for PREPANDEMIC experiences - fine for self-harm as questions explicitly ask about BEFORE the pandemic
FOR LOW WEIGHT/BINGE EATING:

1. Age + (length of time at low weight) = maximum
2. 
