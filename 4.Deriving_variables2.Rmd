...
dat <- dat %>%
  mutate(outcome_phase_binge_eating =
           case_when( is.na(ed_scid5.regular_episodes_eating_binges_.Wave_1b) &
                       ...
                       is.na(ed_scid5.regular_episodes_eating_binges_.Wave_8b) &
                       is.na(ed_scid5.regular_episodes_eating_binges_.Wave_10b)  &
                       is.na(ed_scid5.regular_episodes_eating_binges_.Wave_12b) ~ "Not answered", 
...
dat <- dat %>%
  mutate(outcome_phase_low_weight =
           case_when(is.na(ed_scid5.weigh_weighed_past_month_.Wave_1b ) &
                       ...
                       is.na(ed_scid5.weigh_weighed_past_month_.Wave_8b) &
                       is.na(ed_scid5.weigh_weighed_past_month_.Wave_10b) &
                       is.na(ed_scid5.weigh_weighed_past_month_.Wave_12b) ~ "Not answered", 
...
dat <- dat %>%
  mutate(exposure_phase_positive_covid_test =
           case_when(  is.na(virus.past_surveys_include_reported_.Wave_1b)  &
                       ...
                       is.na(virus.past_surveys_include_reported_.Wave_12b)  ~ "Not answered whether test taken", 
                       ...
                       (is.na(virus.past_surveys_include_reported_.Wave_1b ) |
                        ...
                        virus.past_surveys_include_reported_.Wave_12b == "No")  ~ "Not taken test", 
                       ...
                       is.na(virus.back_positive_antibodies_covid_.Wave_12b)  ~ "Test taken but not answered test result", 
  ...
  mutate(positive_covid_test_BE_1b =
           case_when(exposure_phase_positive_covid_test == "1b" & # First positive COVID test at phase 1b
                      ...
                      (outcome_phase_binge_eating == "1b" |  # Co-occurring outcome and exposure
                       ...
                       outcome_phase_binge_eating == "12b") ~ "Yes"  # Experienced outcome AFTER or at SAME TIME as exposure
                     )
  )
...
dat <- dat %>%
  mutate(positive_covid_test_before_BE =
           case_when(# First positive test NOT before first experience of binge eating
                    ...
                    positive_covid_test_BE_12b == "To drop" ~ "Positive test after binge eating",
                    ...
                    positive_covid_test_BE_12b == "Yes" ~ "Positive test before binge eating",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    positive_covid_test_BE_12b == "No outcome" ~ "Exposure but no outcome",
  ...
  mutate(positive_covid_test_LW_2b =
           case_when(exposure_phase_positive_covid_test == "2b" &
                     ...
                     exposure_phase_positive_covid_test == "2b" & 
                       ...
                       outcome_phase_low_weight == "8b" |
                       outcome_phase_low_weight == "10b" |
                       outcome_phase_low_weight == "12b") ~ "Yes"  # Experienced outcome AFTER or at SAME TIME as exposure
                     )
  )
...
dat <- dat %>%
  mutate(positive_covid_test_before_LW =
           case_when(# First positive test NOT before first experience of low weight
                    ...
                    positive_covid_test_LW_12b == "To drop" ~ "Positive test after low weight",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    positive_covid_test_LW_12b == "No outcome" ~ "Exposure but no outcome",
  ...
  mutate(positive_covid_test_PSS_1b =
           case_when(exposure_phase_positive_covid_test == "1b" & # First positive COVID test at phase 1b
                     ...
                     exposure_phase_positive_covid_test == "1b" & # First positive COVID test at phase 1b
                       ...
                       outcome_phase_passive_suicidal_ideation == "12b") ~ "Yes" # Experienced outcome AFTER or at SAME TIME as exposure
                     )
  )
...
dat <- dat %>%
  mutate(positive_covid_test_before_PSS =
           case_when(# First positive test NOT before first experience of outcome
                    ...
                    positive_covid_test_PSS_12b == "To drop" ~ "Positive test after passive suicidal ideation",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    positive_covid_test_PSS_12b == "No outcome" ~ "Exposure but no outcome",
           ...
           case_when(exposure_phase_positive_covid_test == "1b" & # First positive COVID test at phase 1b
                    ...
                    exposure_phase_positive_covid_test == "1b" & # First positive COVID test at phase 1b
                     ...
                     exposure_phase_positive_covid_test == "1b" & # First positive COVID test at phase 1b
                       ...
                       outcome_phase_selfharm_ideation == "12b") ~ "Yes" # Experienced outcome AFTER or at SAME TIME as exposure
                     )
  )
           ...
           case_when(exposure_phase_positive_covid_test == "12b" & # First positive COVID test at phase 12b
                     ...
                     exposure_phase_positive_covid_test == "12b" & # First positive COVID test at phase 12b
                      (outcome_phase_selfharm_ideation == "Baseline" |
                       ...
                       outcome_phase_selfharm_ideation == "9a" |
                       outcome_phase_selfharm_ideation == "10b" |
                       outcome_phase_selfharm_ideation == "11a") ~ "To drop", # First self-harm ideation occurred before first positive COVID test - need to drop
                     
                     exposure_phase_positive_covid_test == "12b" & # Positive COVID test at phase 12b
                     outcome_phase_selfharm_ideation == "12b" ~ "Yes" # Co-occurring outcome and exposure
                     )
         )
...
dat <- dat %>%
  mutate(positive_covid_test_before_SHI =
           case_when(# First positive test NOT before first experience of outcome
                    ...
                    positive_covid_test_SHI_12b == "To drop" ~ "Positive test after self-harm ideation",
                    ...
                    positive_covid_test_SHI_12b == "Yes" ~ "Positive test before self-harm ideation",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    positive_covid_test_SHI_12b == "No outcome" ~ "Exposure but no outcome",
           ...
           case_when(exposure_phase_positive_covid_test == "1b" & # First positive COVID test at phase 1b
                    ...
                    exposure_phase_positive_covid_test == "1b" & # First positive COVID test at phase 1b
                     ...
                     exposure_phase_positive_covid_test == "1b" & # First positive COVID test at phase 1b
                       ...
                       outcome_phase_selfharm == "12b") ~ "Yes" # Experienced outcome AFTER or at SAME TIME as exposure
                     )
  )
...
dat <- dat %>%
  mutate(positive_covid_test_SH_12b =
           case_when(exposure_phase_positive_covid_test == "12b" & # First positive COVID test at phase 12b
                     ...
                     exposure_phase_positive_covid_test == "12b" & # Positive COVID test at phase 12b
                     outcome_phase_selfharm == "12b" ~ "Yes" # Co-occurring outcome and exposure
                     )
         )
...
dat <- dat %>%
  mutate(positive_covid_test_before_SH =
           case_when(# First positive test NOT before first experience of outcome
                    ...
                    positive_covid_test_SH_12b == "To drop" ~ "Positive test after self-harm",
                    ...
                    positive_covid_test_SH_12b == "Yes" ~ "Positive test before self-harm",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    positive_covid_test_SH_12b == "No outcome" ~ "Exposure but no outcome",
  ...
  mutate(exposure_phase_positive_covid_test2 =
           case_when(  
             # Questions about whether they have taken a test - all missing
                       ...
                       is.na(resp.antibody_test_.Wave_12b) ~ "Not answered whether taken test",
           ...
           (is.na(resp.nose_throat_swab_test_.Wave_12b) |
                       resp.nose_throat_swab_test_.Wave_12b == "No") &
                        ...
                        (is.na(resp.antibody_test_.Wave_12b) |
                         resp.antibody_test_.Wave_12b == "No") ~ "Not taken test",
         ...
         # Question about results of their test
           ...
           is.na(resp.results_nose_throat_swab_test_.Wave_12b) &
                        is.na(resp.results_antibody_test_.Wave_12b) ~ "Taken test but not indicated result", 
  ...
  mutate(positive_covid_test_BE_4b2 =
           case_when(exposure_phase_positive_covid_test2 == "4b" &
                    ...
                    (outcome_phase_binge_eating == "4b" | # Co-occurring outcome and exposure
                     ...
                     outcome_phase_binge_eating == "8b" |
                     outcome_phase_binge_eating == "10b" |
                       outcome_phase_binge_eating == "12b") ~ "Yes" 
         ) 
  )
  ...
  mutate(positive_covid_test_BE_12b2 =
           case_when(exposure_phase_positive_covid_test2 == "12b" &
                    ...
                    outcome_phase_binge_eating == "Not experienced" ~ "No outcome",  # Never experienced outcome (people who are all NA are coded as "Not answered")
                     ...
                     exposure_phase_positive_covid_test2 == "12b" & # First positive COVID test at phase 12b
                    outcome_phase_binge_eating == "12b" ~ "Yes" # Co-occuring symptom and exposure
  ...
  mutate(positive_covid_test_before_BE2 =
           case_when(# First exposure NOT before first experience of outcome
              ...
              positive_covid_test_BE_11a2 == "To drop" |
                    positive_covid_test_BE_12b2 == "To drop" ~ "Positive test after binge eating",
             ...
             positive_covid_test_BE_1b2 == "Yes" |
              ...
              positive_covid_test_BE_2b2 == "Yes" |
               ...
               positive_covid_test_BE_11a2 == "Yes" |
                    positive_covid_test_BE_12b2 == "Yes" ~ "Positive test before binge eating",
             ...
             positive_covid_test_BE_1a2 == "No outcome" |
               ...
               positive_covid_test_BE_11a2 == "No outcome" |
                    positive_covid_test_BE_12b2 == "No outcome" ~ "Exposure but no outcome",
  ...
  mutate(positive_covid_test_LW_4b2 =
           case_when(exposure_phase_positive_covid_test2 == "4b" &
                    ...
                    (outcome_phase_low_weight == "4b" | # Co-occurring outcome and exposure
                     ...
                     outcome_phase_low_weight == "8b" |
                     outcome_phase_low_weight == "10b" |
                       outcome_phase_low_weight == "12b") ~ "Yes" 
         ) 
  )
  ...
  mutate(positive_covid_test_LW_12b2 =
           case_when(exposure_phase_positive_covid_test2 == "12b" &
                    ...
                    outcome_phase_low_weight == "Not experienced" ~ "No outcome",  # Never experienced outcome (people who are all NA are coded as "Not answered")
                     ...
                     exposure_phase_positive_covid_test2 == "12b" & # First positive COVID test at phase 12b
                    outcome_phase_low_weight == "12b" ~ "Yes" # Co-occurring symptom and exposure
  ...
  mutate(positive_covid_test_before_LW2 =
           case_when(# First exposure NOT before first experience of outcome
              ...
              positive_covid_test_LW_11a2 == "To drop" |
                    positive_covid_test_LW_12b2 == "To drop" ~ "Positive test after low weight",
             ...
             positive_covid_test_LW_1b2 == "Yes" |
              ...
              positive_covid_test_LW_2b2 == "Yes" |
               ...
               positive_covid_test_LW_11a2 == "Yes" |
                    positive_covid_test_LW_12b2 == "Yes" ~ "Positive test before low weight",
             ...
             positive_covid_test_LW_1a2 == "No outcome" |
               ...
               positive_covid_test_LW_11a2 == "No outcome" |
                    positive_covid_test_LW_12b2 == "No outcome" ~ "Exposure but no outcome",
  ...
  mutate(positive_covid_test_PSS_4b2 =
           case_when(exposure_phase_positive_covid_test2 == "4b" &
                    ...
                    (outcome_phase_passive_suicidal_ideation == "4b" | # Co-occurring outcome and exposure
                     ...
                     outcome_phase_passive_suicidal_ideation == "10b" |
                       outcome_phase_passive_suicidal_ideation == "11a" | 
                     outcome_phase_passive_suicidal_ideation == "12b") ~ "Yes" 
         ) 
  )
  ...
  mutate(positive_covid_test_PSS_12b2 =
           case_when(exposure_phase_positive_covid_test2 == "12b" &
                   ...
                   outcome_phase_passive_suicidal_ideation == "Not experienced" ~ "No outcome",  # Never experienced outcome (people who are all NA are coded as "Not answered")
                     ...
                     exposure_phase_positive_covid_test2 == "12b" & # First positive COVID test at phase 12b
                    outcome_phase_passive_suicidal_ideation == "12b" ~ "Yes" # Co-occurring symptom and exposure
  ...
  mutate(positive_covid_test_before_PSS2 =
           case_when(# First positive test NOT before first experience of passive suicidal ideation
              ...
              positive_covid_test_PSS_11a2 == "To drop" |
                    positive_covid_test_PSS_12b2 == "To drop" ~ "Positive test after passive suicidal ideation",
             ...
             positive_covid_test_PSS_1b2 == "Yes" |
              ...
              positive_covid_test_PSS_2b2 == "Yes" |
               ...
               positive_covid_test_PSS_11a2 == "Yes" |
                    positive_covid_test_PSS_12b2 == "Yes" ~ "Positive test before passive suicidal ideation",
             ...
             positive_covid_test_PSS_1a2 == "No outcome" |
               ...
               positive_covid_test_PSS_11a2 == "No outcome" |
                    positive_covid_test_PSS_12b2 == "No outcome" ~ "Exposure but no outcome",
           ...
           case_when(exposure_phase_positive_covid_test2 == "4b" &
                   ...
                   outcome_phase_selfharm_ideation == "Not experienced" ~ "No outcome",  # Never experienced outcome (people who are all NA are coded as "Not answered")
                    ...
                    (outcome_phase_selfharm_ideation == "4b" | # Co-occurring outcome and exposure
                     ...
                     outcome_phase_selfharm_ideation == "10b" |
                       outcome_phase_selfharm_ideation == "11a" | 
                     outcome_phase_selfharm_ideation == "12b") ~ "Yes" 
         ) 
  )
  ...
  mutate(positive_covid_test_SHI_12b2 =
           case_when(exposure_phase_positive_covid_test2 == "12b" &
                    ...
                    outcome_phase_selfharm_ideation == "Not experienced" ~ "No outcome",  # Never experienced outcome (people who are all NA are coded as "Not answered")
                     ...
                     exposure_phase_positive_covid_test2 == "12b" & # First positive COVID test at phase 12b
                    outcome_phase_selfharm_ideation == "12b" ~ "Yes" # Co-occurring symptom and exposure
  ...
  mutate(positive_covid_test_before_SHI2 =
           case_when(# First positive test NOT before first experience of self-harm ideation
              ...
              positive_covid_test_SHI_11a2 == "To drop" |
                    positive_covid_test_SHI_12b2 == "To drop" ~ "Positive test after self-harm ideation",
             ...
             positive_covid_test_SHI_1b2 == "Yes" |
              ...
              positive_covid_test_SHI_2b2 == "Yes" |
               ...
               positive_covid_test_SHI_11a2 == "Yes" |
                    positive_covid_test_SHI_12b2 == "Yes" ~ "Positive test before self-harm ideation",
             ...
             positive_covid_test_SHI_1a2 == "No outcome" |
               ...
               positive_covid_test_SHI_11a2 == "No outcome" |
                    positive_covid_test_SHI_12b2 == "No outcome" ~ "Exposure but no outcome",
  ...
  mutate(positive_covid_test_SH_4b2 =
           case_when(exposure_phase_positive_covid_test2 == "4b" &
                    ...
                    (outcome_phase_selfharm == "4b" | # Co-occurring outcome and exposure
                     ...
                     outcome_phase_selfharm == "10b" |
                       outcome_phase_selfharm == "11a" | 
                     outcome_phase_selfharm == "12b") ~ "Yes" 
         ) 
  )
  ...
  mutate(positive_covid_test_SH_12b2 =
           case_when(exposure_phase_positive_covid_test2 == "12b" &
                    ...
                    outcome_phase_selfharm == "Not experienced" ~ "No outcome",  # Never experienced outcome (people who are all NA are coded as "Not answered")
                     ...
                     exposure_phase_positive_covid_test2 == "12b" & # First positive COVID test at phase 12b
                    outcome_phase_selfharm == "12b" ~ "Yes" # Co-occurring symptom and exposure
  ...
  mutate(positive_covid_test_before_SH2 =
           case_when(# First positive test NOT before first experience of self-harm 
              ...
              positive_covid_test_SH_11a2 == "To drop" |
                    positive_covid_test_SH_12b2 == "To drop" ~ "Positive test after self-harm",
             ...
             positive_covid_test_SH_1b2 == "Yes" |
              ...
              positive_covid_test_SH_2b2 == "Yes" |
               ...
               positive_covid_test_SH_11a2 == "Yes" |
                    positive_covid_test_SH_12b2 == "Yes" ~ "Positive test before self-harm",
             ...
             positive_covid_test_SH_1a2 == "No outcome" |
               ...
               positive_covid_test_SH_11a2 == "No outcome" |
                    positive_covid_test_SH_12b2 == "No outcome" ~ "Exposure but no outcome",
  ...
  mutate(lost_someone_BE_12b =
           case_when(exposure_phase_losing_someone == "12b" & # First indicated losing someone at phase 12b
                    ...
                    outcome_phase_binge_eating == "Not experienced" ~ "No outcome",  # Never experienced outcome (people who are all NA are coded as "Not answered")
                     ...
                     exposure_phase_losing_someone == "12b" & # First indicated losing someone at phase 12b
                    outcome_phase_binge_eating == "12b" ~ "Yes" # Co-occurring symptom and exposure
...
dat <- dat %>%
  mutate(losing_someone_before_BE =
           case_when(# First lost someone NOT before first experience of binge eating
                    ...
                    lost_someone_BE_12b == "To drop" ~ "Lost someone after binge eating",
                  ...
                  # First lost someone BEFORE first experience of binge eating
                    ...
                    lost_someone_BE_12b == "Yes" ~ "Lost someone before binge eating",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    lost_someone_BE_12b == "No outcome"  ~ "Exposure but no outcome",
...
dat <- dat %>%
  mutate(losing_someone_before_LW =
           case_when(# First lost someone NOT before first experience of low weight
                    ...
                    lost_someone_LW_12b == "To drop" ~ "Lost someone after low weight",
                  ...
                  # First lost someone BEFORE first experience of low weight
                    ...
                    lost_someone_LW_12b == "Yes" ~ "Lost someone before low weight",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    lost_someone_LW_12b == "No outcome"  ~ "Exposure but no outcome",
...
dat <- dat %>%
  mutate(losing_someone_before_PSS =
           case_when(# First lost someone NOT before first experience of passive suicidal ideation
                    ...
                    lost_someone_PSS_12b == "To drop" ~ "Lost someone after passive suicidal ideation",
                  ...
                  # First lost someone BEFORE first experience of passive suicidal ideation
                    ...
                    lost_someone_PSS_12b == "Yes" ~ "Lost someone before passive suicidal ideation",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    lost_someone_PSS_12b == "No outcome"  ~ "Exposure but no outcome",
...
dat <- dat %>%
  mutate(losing_someone_before_SHI =
           case_when(# First lost someone NOT before first experience of self-harm ideation
                    ...
                    lost_someone_SHI_12b == "To drop" ~ "Lost someone after self-harm ideation",
                  ...
                  # First lost someone BEFORE first experience of self-harm ideation
                    ...
                    lost_someone_SHI_12b == "Yes" ~ "Lost someone before self-harm ideation",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    lost_someone_SHI_12b == "No outcome"  ~ "Exposure but no outcome",
...
dat <- dat %>%
  mutate(losing_someone_before_SH =
           case_when(# First lost someone NOT before first experience of self-harm 
                    ...
                    lost_someone_SH_12b == "To drop" ~ "Lost someone after self-harm",
                  ...
                  # First lost someone BEFORE first experience of self-harm
                    ...
                    lost_someone_SH_12b == "Yes" ~ "Lost someone before self-harm",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    lost_someone_SH_12b == "No outcome"  ~ "Exposure but no outcome",
           ...
           case_when(
                     ...
                     # Missing at baseline and all phases
                      ...
                      is.na(employ.my_employment_status_has_not_changed) & # Not answered whether employment has changed at baseline
                       ...
                       is.na(dem.employment_.Wave_12b) ~ "Missing at every phase", # Not answered whether employment has changed in the last two weeks 
                      ...
                      employ.my_employment_status_has_not_changed == "My employment status has not changed" | # Not experienced change in employment at baseline
                       ...
                       dem.employment_.Wave_12b == "Not Employment" ~ "No change in eco activity" # Have experienced change but not in the employment domain
...
dat <- dat %>%
  mutate(main_eco_change_before_BE =
           case_when(# First exposure NOT before first experience of outcome   
                    ...
                    main_eco_change_BE_12b == "To drop" ~ "Change in eco activity after binge eating",
                  ...
                  # First exposure before first outcome
                    ...
                    main_eco_change_BE_12b == "Yes" ~ "Change in eco activity before binge eating",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    main_eco_change_BE_12b == "No outcome"  ~ "Exposure but no outcome",
...
dat <- dat %>%
  mutate(main_eco_change_before_LW =
           case_when(# First exposure NOT before first experience of outcome   
                    ...
                    main_eco_change_LW_12b == "To drop" ~ "Change in eco activity after low weight",
                  ...
                  # First exposure BEFORE first experience of outcome
                    ...
                    main_eco_change_LW_12b == "Yes" ~ "Change in eco activity before low weight",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    main_eco_change_LW_12b == "No outcome"  ~ "Exposure but no outcome",
...
dat <- dat %>%
  mutate(main_eco_change_before_PSS =
           case_when(# First exposure NOT before first experience of outcome   
                    ...
                    main_eco_change_PSS_12b == "To drop" ~ "Change in eco activity after passive suicidal ideation",
                  ...
                  # First exposure BEFORE first experience of outcome
                    ...
                    main_eco_change_PSS_12b == "Yes" ~ "Change in eco activity before passive suicidal ideation",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    main_eco_change_PSS_12b == "No outcome"  ~ "Exposure but no outcome",
...
dat <- dat %>%
  mutate(main_eco_change_before_SHI =
           case_when(# First exposure NOT before first experience of outcome   
                    ...
                    main_eco_change_SHI_12b == "To drop" ~ "Change in eco activity after self-harm ideation",
                  ...
                  # First exposure BEFORE first experience of outcome
                    ...
                    main_eco_change_SHI_12b == "Yes" ~ "Change in eco activity before self-harm ideation",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    main_eco_change_SHI_12b == "No outcome"  ~ "Exposure but no outcome",
...
dat <- dat %>%
  mutate(main_eco_change_before_SH =
           case_when(# First exposure NOT before first experience of outcome   
                    ...
                    main_eco_change_SH_12b == "To drop" ~ "Change in eco activity after self-harm",
                  ...
                  # First exposure BEFORE first experience of outcome
                    ...
                    main_eco_change_SH_12b == "Yes" ~ "Change in eco activity before self-harm",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    main_eco_change_SH_12b == "No outcome"  ~ "Exposure but no outcome",
           ...
           case_when(
                     ...
                     # Missing at baseline and all phases
                      ...
                      is.na(dem.living_situation_.Wave_1a) &  # Has anything changed in the following domains in the last two weeks: Living situation
                       ...
                       is.na(dem.living_situation_.Wave_12b) ~ "Missing at every phase", # Not answered whether living situation has changed in the last two weeks 
                      ...
                      dem2.living_situation_change_pandemic == "No" | # Not experienced change in living situation at baseline
                       ...
                       dem.living_situation_.Wave_12b == "Not Living situation" ~ "No change in living situation" # Have experienced change but not in the employment domain
...
dat <- dat %>%
  mutate(living_situation_change_before_BE =
           case_when(# First exposure NOT before first experience of outcome   
                    ...
                    living_situation_change_BE_12b == "To drop" ~ "Change in living situation after binge eating",
                  ...
                  # First exposure BEFORE first experience of outcome
                    ...
                    living_situation_change_BE_12b == "Yes" ~ "Change in living situation before binge eating",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    living_situation_change_BE_12b == "No outcome"  ~ "Exposure but no outcome",
...
dat <- dat %>%
  mutate(living_situation_change_before_LW =
           case_when(# First exposure NOT before first experience of outcome   
                    ...
                    living_situation_change_LW_12b == "To drop" ~ "Change in living situation after low weight",
                  ...
                  # First exposure BEFORE first experience of outcome
                    ...
                    living_situation_change_LW_12b == "Yes" ~ "Change in living situation before low weight",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    living_situation_change_LW_12b == "No outcome"  ~ "Exposure but no outcome",
...
dat <- dat %>%
  mutate(living_situation_change_before_PSS =
           case_when(# First exposure NOT before first experience of outcome   
                    ...
                    living_situation_change_PSS_12b == "To drop" ~ "Change in living situation after passive suicidal ideation",
                  ...
                  # First exposure BEFORE first experience of outcome
                    ...
                    living_situation_change_PSS_12b == "Yes" ~ "Change in living situation before passive suicidal ideation",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    living_situation_change_PSS_12b == "No outcome"  ~ "Exposure but no outcome",
...
dat <- dat %>%
  mutate(living_situation_change_before_SHI =
           case_when(# First exposure NOT before first experience of outcome   
                    ...
                    living_situation_change_SHI_12b == "To drop" ~ "Change in living situation after self-harm ideation",
                  ...
                  # First exposure BEFORE first experience of outcome
                    ...
                    living_situation_change_SHI_12b == "Yes" ~ "Change in living situation before self-harm ideation",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    living_situation_change_SHI_12b == "No outcome"  ~ "Exposure but no outcome",
...
dat <- dat %>%
  mutate(living_situation_change_before_SH =
           case_when(# First exposure NOT before first experience of outcome   
                    ...
                    living_situation_change_SH_12b == "To drop" ~ "Change in living situation after self-harm",
                  ...
                  # First exposure BEFORE first experience of outcome
                    ...
                    living_situation_change_SH_12b == "Yes" ~ "Change in living situation before self-harm",
                   ...
                   # Experienced exposure but not outcome
                    ...
                    living_situation_change_SH_12b == "No outcome"  ~ "Exposure but no outcome",
