---
title: "Correcting duplicated entries"
author: "Helena Davies"
date: "21/02/2022"
output: html_document
---

This script takes into consideration duplicated entries within a single phase, as well as screener questions.
...
```{r Read in data}
dat <- readRDS(file = paste0(filepath_saved_data, "all_dat2022-09-27.rds"))
...
## Demographics
No screener question for this variable.
...
# NB: There is no data on ill health due to COVID until wave 6 as this question was added partway through data collection
Screener question: Has anything changed in the following domains in the last two weeks: physical health?
dem.unwell_coronavirus_weeks_physical = In the last two weeks, has your physical health changed because you became unwell with the coronavirus?
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_1a =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_1a == "Yes" |
                    ...
                    dem.physical_health_.Wave_1a == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_1a_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_1a == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_1b =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_1b == "Yes" |
                   ...
                   dem.physical_health_.Wave_1b == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_1b_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_1b == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_2a =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_2a == "Yes" |
                  ...
                  dem.physical_health_.Wave_2a == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_2a_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_2a == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_2b =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_2b == "Yes" |
                    ...
                    dem.physical_health_.Wave_2b == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_2b_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_2b == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_3a =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_3a == "Yes" |
                   ...
                   dem.physical_health_.Wave_3a == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_3a_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_3a == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_3b =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_3b == "Yes" |
                    ...
                    dem.physical_health_.Wave_3b== "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_3b_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_3b == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_4a =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_4a == "Yes" |
                  ...
                  dem.physical_health_.Wave_4a== "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_4a_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_4a == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_4b =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_4b == "Yes" |
                   ...
                   dem.physical_health_.Wave_4b == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_4b_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_4b  == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_5a =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_5a == "Yes" |
                   ...
                   dem.physical_health_.Wave_5a == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_5a_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_5a  == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_6b =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_6b== "Yes" |
                    ...
                    dem.physical_health_.Wave_6b == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_6b_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_6b  == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_7a =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_7a == "Yes" |
                   ...
                   dem.physical_health_.Wave_7a == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_7a_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_7a  == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_8b =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_8b == "Yes" |
                   ...
                   dem.physical_health_.Wave_8b == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_8b_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_8b  == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_9a =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_9a == "Yes" |
                   ...
                   dem.physical_health_.Wave_9a == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_9a_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_9a  == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_10b =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_10b == "Yes" |
                  ...
                  dem.physical_health_.Wave_10b == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_10b_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_10b  == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_11a =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_11a == "Yes" |
                    ...
                    dem.physical_health_.Wave_11a == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_11a_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_11a  == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_12b =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_12b == "Yes" |
                   ...
                   dem.physical_health_.Wave_12b == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_12b_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_12b  == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_13a =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_13a == "Yes" |
                   ...
                   dem.physical_health_.Wave_13a == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_13a_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_13a  == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_14b =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_14b == "Yes" |
                    ...
                    dem.physical_health_.Wave_14b == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_14b_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_14b  == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_15a =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_15a == "Yes" |
                   ...
                   dem.physical_health_.Wave_15a == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_15a_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_15a  == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
...
dat <- dat %>%
  mutate(dem.unwell_coronavirus_weeks_physical_.Wave_16b =
           case_when(dem.unwell_coronavirus_weeks_physical_.Wave_16b == "Yes" |
                   ...
                   dem.physical_health_.Wave_16b == "Not Physical health" | # Said no to screener...
                    dem.physical_health_.Wave_16b_dup == "Not Physical health" | 
                    dem.unwell_coronavirus_weeks_physical_.Wave_16b == "No" | # ...or said Yes to screener but "No" to being ill with COVID 
                    dem.unwell_coronavirus_weeks_physical_.Wave_16b_dup == "No" ~ "No"
                   )
         )
```

Screener question: Has anything changed in the following domains in the last two weeks: Health of a relative
dem.coronavirus_relative_previously_ill.1 = Has a relative that was previously ill with coronavirus or suspected coronavirus passed away?
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_1a =
           case_when(
             dem.coronavirus_relative_previously_ill.1_.Wave_1a == "Yes" |
                      dem.coronavirus_relative_previously_ill.1_.Wave_1a_dup == "Yes" ~ "Yes",
                     
                   dem.health_of_a_relative_.Wave_1a == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_1a_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_1a == "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_1b =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_1b == "Yes" |
                   ...
                   dem.health_of_a_relative_.Wave_1b == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_1b_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_1b== "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_2a =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_2a == "Yes" |
                     ...
                     dem.health_of_a_relative_.Wave_2a  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_2a_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_2a== "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_2b =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_2b == "Yes" |
                   ...
                   dem.health_of_a_relative_.Wave_2b  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_2b_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_2b== "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_3a =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_3a == "Yes" |
                  ...
                  dem.health_of_a_relative_.Wave_3a  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_3a_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_3a== "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_3b =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_3b == "Yes" |
                   ...
                   dem.health_of_a_relative_.Wave_3b  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_3b_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_3b== "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_4a =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_4a == "Yes" |
                   ...
                   dem.health_of_a_relative_.Wave_4a  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_4a_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_4a== "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_4b =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_4b == "Yes" |
                  ...
                  dem.health_of_a_relative_.Wave_4b  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_4b_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_4b== "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_5a =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_5a == "Yes" |
                  ...
                  dem.health_of_a_relative_.Wave_5a  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_5a_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_5a== "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_6b =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_6b== "Yes" |
                   ...
                   dem.health_of_a_relative_.Wave_6b  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_6b_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_6b == "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_7a =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_7a == "Yes" |
                   ...
                   dem.health_of_a_relative_.Wave_7a  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_7a_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_7a == "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_8b =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_8b == "Yes" |
                   ...
                   dem.health_of_a_relative_.Wave_8b  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_8b_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_8b == "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_9a =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_9a == "Yes" |
                   ...
                   dem.health_of_a_relative_.Wave_9a  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_9a_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_9a == "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_10b =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_10b == "Yes" |
                   ...
                   dem.health_of_a_relative_.Wave_10b  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_10b_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_10b == "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_11a =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_11a == "Yes" |
                  ...
                  dem.health_of_a_relative_.Wave_11a  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_11a_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_11a == "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_12b =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_12b == "Yes" |
                   ...
                   dem.health_of_a_relative_.Wave_12b  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_12b_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_12b == "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_13a =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_13a == "Yes" |
                   ...
                   dem.health_of_a_relative_.Wave_13a  == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_13a_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_13a == "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_14b =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_14b == "Yes" |
                    ...
                    dem.health_of_a_relative_.Wave_14b   == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_14b_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_14b == "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_15a =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_15a == "Yes" |
                    ...
                    dem.health_of_a_relative_.Wave_15a   == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_15a_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_15a == "No" |  # ...or said Yes to screener but "No" to relative passing away
...
dat <- dat %>%
  mutate(dem.coronavirus_relative_previously_ill.1_.Wave_16b =
           case_when(dem.coronavirus_relative_previously_ill.1_.Wave_16b == "Yes" |
                   ...
                   dem.health_of_a_relative_.Wave_16b   == "Not Health of a relative" | # Said no to screener...
                   dem.health_of_a_relative_.Wave_16b_dup == "Not Health of a relative" |
                   dem.coronavirus_relative_previously_ill.1_.Wave_16b == "No" |  # ...or said Yes to screener but "No" to relative passing away
...
taf.worth_living_life_people = Many people have thoughts that life is not worth living. Have you felt that way?
...
taf.felt_weeks_past = Have you felt that way in the past two weeks?
Screener: Many people have thoughts that life is not worth living. Have you felt that way? [NB: Screener is taken into account in the relevant outcome script]
...
taf.have_you_contemplated_harming_yourself = Have you contemplated harming yourself ?
...
Screener: Have you contemplated harming yourself ?       
taf.felt_weeks_past.1 = Have you felt that way in the past two weeks? [NB: Screener is taken into account in the relevant outcome script]
...
taf.meant_life_end_weeks = In the last two weeks, have you deliberately harmed yourself, whether or not you meant to end your life?     
...
## Grief questionnaire 
grief.due_past_month_lost = In the past month, have you lost someone close to you due to COVID-19?
...
Have you had a nose/throat swab to test for Coronavirus?
Screener = In the last two weeks, have you experienced persistent loss of smell, a fever, unusual shortness of breath...etc etc (resp.fever_smell_breath_weeks)
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_1a =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_1a == "Yes" |
                    ...
                    resp.screener_followup_.Wave_1a == "No" | # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_1b =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_1b == "Yes" |
                     ...
                     resp.screener_followup_.Wave_1b == "No" | # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_2a =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_2a == "Yes" |
                     ...
                     resp.screener_followup_.Wave_2a == "No" | # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_2b =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_2b == "Yes" |
                     ...
                     resp.screener_followup_.Wave_2b == "No" | # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_3a =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_3a == "Yes" |
                     ...
                     resp.screener_followup_.Wave_3a == "No" |  # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_3b =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_3b == "Yes" |
                     ...
                     resp.screener_followup_.Wave_3b == "No" |  # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_4a =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_4a == "Yes" |
                     ...
                     resp.screener_followup_.Wave_4a == "No" |  # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_4b =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_4b == "Yes" |
                     ...
                     resp.screener_followup_.Wave_4b == "No" |  # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_5a =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_5a == "Yes" |
                     ...
                     resp.screener_followup_.Wave_5a == "No" |   # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_6b =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_6b== "Yes" |
                     ...
                     resp.screener_followup_.Wave_6b == "No" |   # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_7a =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_7a == "Yes" |
                     ...
                     resp.screener_followup_.Wave_7a == "No" |    # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_8b =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_8b == "Yes" |
                     ...
                     resp.screener_followup_.Wave_8b == "No" | # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_9a =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_9a == "Yes" |
                     ...
                     resp.screener_followup_.Wave_9a == "No" | # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_10b =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_10b == "Yes" |
                     ...
                     resp.screener_followup_.Wave_10b == "No" |  # Not passed screener   
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_11a =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_11a == "Yes" |
                     ...
                     resp.screener_followup_.Wave_11a == "No" |  # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_12b =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_12b == "Yes" |
                     ...
                     resp.screener_followup_.Wave_12b == "No" |    # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_13a =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_13a == "Yes" |
                     ...
                     resp.screener_followup_.Wave_13a == "No" | # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_14b =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_14b == "Yes" |
                   ...
                   resp.screener_followup_.Wave_14b == "No" | # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_15a =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_15a == "Yes" |
                     ...
                     resp.screener_followup_.Wave_15a == "No" |    # Not passed screener
...
dat <- dat %>%
  mutate(resp.coronavirus_test_nosethroat_swab_.Wave_16b =
           case_when(resp.coronavirus_test_nosethroat_swab_.Wave_16b == "Yes" |
                     ...
                     resp.screener_followup_.Wave_16b == "No" |   # Not passed screener
...
resp.results_nosethroat_swab_test = What were the results of the nose/throat swab test?         
Screener = In the last two weeks, have you experienced persistent loss of smell, a fever, unusual shortness of breath...etc etc
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_1a =
           case_when(resp.screener_followup_.Wave_1a == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_1b =
           case_when(resp.screener_followup_.Wave_1b == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_2a =
           case_when(resp.screener_followup_.Wave_2a == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_2b =
           case_when(resp.screener_followup_.Wave_2b == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_3a =
           case_when(resp.screener_followup_.Wave_3a == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_3b =
           case_when(resp.screener_followup_.Wave_3b == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_4a =
           case_when(resp.screener_followup_.Wave_4a == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_4b =
           case_when(resp.screener_followup_.Wave_4b == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_5a =
           case_when(resp.screener_followup_.Wave_5a == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_6b =
           case_when(resp.screener_followup_.Wave_6b == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_7a =
           case_when(resp.screener_followup_.Wave_7a == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_8b =
           case_when(resp.screener_followup_.Wave_8b == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_9a =
           case_when(resp.screener_followup_.Wave_9a == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_10b =
           case_when(resp.screener_followup_.Wave_10b == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_11a =
           case_when(resp.screener_followup_.Wave_11a == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_12b =
           case_when(resp.screener_followup_.Wave_12b == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_13a =
           case_when(resp.screener_followup_.Wave_13a == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_14b =
           case_when(resp.screener_followup_.Wave_14b == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_15a =
           case_when(resp.screener_followup_.Wave_15a == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.results_nosethroat_swab_test_.Wave_16b =
           case_when(resp.screener_followup_.Wave_16b == "No" ~ "Not passed screener",
...
dat <- dat %>%
  mutate(resp.coronavirus_antibody_test_.Wave_1a =
           case_when(
             resp.coronavirus_antibody_test_.Wave_1a == "Yes" |
...
resp.results_antibody_test = What were the results of the antibody test?
Screener = In the last two weeks, have you experienced persistent loss of smell, a fever, unusual shortness of breath...etc etc
...
## Virus questionnaire 
virus.back_positive_antibodies_tests = Have any of your tests come back positive for COVID-19 or antibodies?
Screener = Have you ever had a COVID-19 test? (virus.past_surveys_include_covid19)
           ...
           case_when(
             virus.back_positive_antibodies_tests_.Wave_1b == "Yes" |
                   ...
                   virus.past_surveys_include_covid19_.Wave_1b == "No" |
                    virus.past_surveys_include_covid19_.Wave_1b_dup == "No" |
...
dat <- dat %>%
  mutate(virus.back_positive_antibodies_tests_.Wave_2b =
           case_when(virus.back_positive_antibodies_tests_.Wave_2b == "Yes" |
                    ...
                    virus.past_surveys_include_covid19_.Wave_2b_dup == "No" |
...
dat <- dat %>%
  mutate(virus.back_positive_antibodies_tests_.Wave_3b =
           case_when(virus.back_positive_antibodies_tests_.Wave_3b == "Yes" |
                    ...
                    virus.past_surveys_include_covid19_.Wave_3b_dup == "No" |
...
dat <- dat %>%
  mutate(virus.back_positive_antibodies_tests_.Wave_4b =
           case_when(virus.back_positive_antibodies_tests_.Wave_4b == "Yes" |
                    ...
                    virus.past_surveys_include_covid19_.Wave_4b_dup == "No" |
...
dat <- dat %>%
  mutate(virus.back_positive_antibodies_tests_.Wave_6b =
           case_when(virus.back_positive_antibodies_tests_.Wave_6b== "Yes" |
                    ...
                    virus.past_surveys_include_covid19_.Wave_6b_dup == "No" |  
...
dat <- dat %>%
  mutate(virus.back_positive_antibodies_tests_.Wave_8b =
           case_when(virus.back_positive_antibodies_tests_.Wave_8b == "Yes" |
                    ...
                    virus.past_surveys_include_covid19_.Wave_8b_dup == "No" |
...
dat <- dat %>%
  mutate(virus.back_positive_antibodies_tests_.Wave_10b =
           case_when(virus.back_positive_antibodies_tests_.Wave_10b == "Yes" |
                    ...
                    virus.past_surveys_include_covid19_.Wave_10b_dup == "No" |  
  ...
  mutate(virus.back_positive_antibodies_tests_.Wave_12b =
           case_when(virus.back_positive_antibodies_tests_.Wave_12b == "Yes" |
                   ...
                   virus.past_surveys_include_covid19_.Wave_12b == "No" |
                    virus.past_surveys_include_covid19_.Wave_12b_dup == "No" |
...
dat <- dat %>%
  mutate(virus.back_positive_antibodies_tests_.Wave_14b =
           case_when(virus.back_positive_antibodies_tests_.Wave_14b == "Yes" |
                    ...
                    virus.past_surveys_include_covid19_.Wave_14b_dup == "No" |  
...
dat <- dat %>%
  mutate(virus.back_positive_antibodies_tests_.Wave_16b =
           case_when(virus.back_positive_antibodies_tests_.Wave_16b == "Yes" |
                    ...
                    virus.past_surveys_include_covid19_.Wave_16b_dup == "No" |  
...
virus.past_surveys_include_covid19 = Have you ever had a COVID-19 test? Please include any tests you've reported in past surveys.
...
```{r save dataset}
saveRDS(object = dat,
       file = paste0(filepath_saved_data, "final_dat_no_dup_entries", date, ".rds"))
```
