...
edgi.9 <- edgi_pan_worry.id %>%
  select(ID,
         ...
         panworry.household_employment_status_key_numeric = panworry.employment_status_household_key_numeric,  # Rename to same as GLAD panworry.impact_on_your_education_or_exams_numeric,            
