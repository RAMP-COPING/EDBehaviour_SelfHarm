...
glad_baseline_resp_id <- glad_baseline_resp_raw %>% #new dataset with ID
  ...
  select(
         ID = externalDataReference, # ID
         sample, # Sample,
         resp.screener_baseline = resp.symptoms_loss_breath_experienced ,
         startDate_baseline = startDate,
...
edgi_baseline_resp_id <- edgi_baseline_resp_raw %>% #new dataset with ID
  ...
  select(
         ...
         sample, # Sample
         startDate_baseline = startDate,
         resp.screener_baseline =resp.taste_fever_unusual_shortness,
         resp.coronavirus_test_nosethroat_swab,
         resp.results_nosethroat_swab_test,
         resp.coronavirus_antibody_test,
         resp.results_antibody_test
...
ramp_baseline_resp_id <- ramp_baseline_resp_raw %>% #new dataset with ID
  ...
  select(
         ...
         sample, # Sample
         startDate_baseline = startDate,
         resp.screener_baseline =resp.fever_unusual_shortness_smell ,
...
coping.followupa1.resp.id <- coping.followupa1.resp %>% #new dataset with ID
  ...
  select(
         ...
         sample, # Sample
         startDate_waves = startDate,
         resp.screener_followup = resp.breath_smell_weeks_experienced,
...
coping.followupa2.resp.id <- coping.followupa2.resp %>% #new dataset with ID
  ...
  select(
         ...
         sample, # Sample
         startDate_waves = startDate,
          resp.screener_followup =resp.smell_breath_weeks_experienced,
         resp.coronavirus_test_nosethroat_swab = resp.test_coronavirus_week_nosethroat,
         resp.results_nosethroat_swab_test,
         resp.coronavirus_antibody_test = resp.coronavirus_week_antibody_test,
         resp.results_antibody_test
...
coping.followupb.resp.id <- coping.followupb.resp %>% #new dataset with ID
  ...
  select(
         ...
         sample, # Sample
         startDate_waves = startDate,
         resp.screener_followup = resp.fever_unusual_shortness_smell,
         resp.coronavirus_test_nosethroat_swab = resp.coronavirus_test_week_nosethroat,
         resp.results_nosethroat_swab_test,
...
dat.raw.dem.ramp.followup <- dat.raw.dem.ramp.followup %>%
  select(ID,
     ...
     `dem.nothing_has_changed_.Wave_1a_dup`,
         `dem.nothing_has_changed_.Wave_1b_dup`,
         `dem.nothing_has_changed_.Wave_2a_dup`,
         `dem.nothing_has_changed_.Wave_2b_dup`,
         `dem.nothing_has_changed_.Wave_3a_dup`,
         `dem.nothing_has_changed_.Wave_3b_dup`,
         `dem.nothing_has_changed_.Wave_4a_dup`,
         `dem.nothing_has_changed_.Wave_4b_dup`,
         `dem.nothing_has_changed_.Wave_5a_dup`,
         `dem.nothing_has_changed_.Wave_6b_dup`,
         `dem.nothing_has_changed_.Wave_7a_dup`,
         `dem.nothing_has_changed_.Wave_8b_dup`,
         `dem.nothing_has_changed_.Wave_9a_dup`,
         `dem.nothing_has_changed_.Wave_10b_dup`,
         `dem.nothing_has_changed_.Wave_11a_dup`,
         `dem.nothing_has_changed_.Wave_12b_dup`,
         `dem.nothing_has_changed_.Wave_13a_dup`,
         `dem.nothing_has_changed_.Wave_14b_dup`,
         `dem.nothing_has_changed_.Wave_15a_dup`,
         `dem.nothing_has_changed_.Wave_16b_dup`,
     
     `dem.physical_health_.Wave_1a_dup`,
         `dem.physical_health_.Wave_1b_dup`,
         `dem.physical_health_.Wave_2a_dup`,
         `dem.physical_health_.Wave_2b_dup`,
         `dem.physical_health_.Wave_3a_dup`,
         `dem.physical_health_.Wave_3b_dup`,
         `dem.physical_health_.Wave_4a_dup`,
         `dem.physical_health_.Wave_4b_dup`,
         `dem.physical_health_.Wave_5a_dup`,
         `dem.physical_health_.Wave_6b_dup`,
         `dem.physical_health_.Wave_7a_dup`,
         `dem.physical_health_.Wave_8b_dup`,
         `dem.physical_health_.Wave_9a_dup`,
         `dem.physical_health_.Wave_10b_dup`,
         `dem.physical_health_.Wave_11a_dup`,
         `dem.physical_health_.Wave_12b_dup`,
         `dem.physical_health_.Wave_13a_dup`,
         `dem.physical_health_.Wave_14b_dup`,
         `dem.physical_health_.Wave_15a_dup`,
         `dem.physical_health_.Wave_16b_dup`,
...
ramp.followup.resp.id <- ramp.followup.resp.id  %>%
  select(ID,
         ...
         `resp.screener_followup_.Wave_1a`,
         `resp.screener_followup_.Wave_1b`,
         `resp.screener_followup_.Wave_2a`,
         `resp.screener_followup_.Wave_2b` ,
         `resp.screener_followup_.Wave_3a`,
         `resp.screener_followup_.Wave_3b` , 
         `resp.screener_followup_.Wave_4a`,
         `resp.screener_followup_.Wave_4b`,
         `resp.screener_followup_.Wave_5a`,
         `resp.screener_followup_.Wave_6b`,
         `resp.screener_followup_.Wave_7a`,
         `resp.screener_followup_.Wave_8b`,
         `resp.screener_followup_.Wave_9a`,
         `resp.screener_followup_.Wave_10b`,
         `resp.screener_followup_.Wave_11a`,
         `resp.screener_followup_.Wave_12b`,
         `resp.screener_followup_.Wave_13a`,
         `resp.screener_followup_.Wave_14b`,
         `resp.screener_followup_.Wave_15a`,
         `resp.screener_followup_.Wave_16b`,
