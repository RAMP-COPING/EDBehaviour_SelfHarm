...
## First, create groups 
```{r create groups}
binge_eating_group <- dat_final %>% # 18,229
...
low_weight_group <- dat_final %>% # 16,390
...
harmful_ideation_group <- dat_final %>% # 12,677
...
selfharm_group <- dat_final %>% # 20,310
...
ggpubr::ggarrange(signup_BMI_whole_sample_qqplot,
          ...
          labels = c("Whole sample (n = 25,206)",
                     "",
                     "Binge eating sub-sample (n = 18,229)",
                     "",
                     "Low weight sub-sample (n = 16,390)",
                     "",
                     "Suicidal and/or self-harm sub-sample (n = 12,677)",
                     "",
                      "Self-harm sub-sample (n = 20,310)"
                     ),
          hjust = 0.001,
          ncol = 2,
          nrow = 5)
