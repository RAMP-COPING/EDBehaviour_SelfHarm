...
# Read in data
```{r Read in dataset}
dat_exposure_info <- readRDS(paste0(filepath_saved_data, "exposures_all_models2022-09-23.rds"))
dat_all_info <- readRDS(paste0(filepath_saved_data, "final_dat_no_dup_entries2022-09-23.rds"))
