...
#Check
nrow(dat.ed.all.final)

colnames(dat.ed.all.final)
...
##Save dataset
```{r}
saveRDS(object = dat.ed.all.final,
        file = paste0("/Users/helenadavies/King's College London/MT-Translational Neuropsychiatric Genomics - Helena_Davies_PhD - Helena_Davies_PhD/EDBeh_SelfHarm/data_cleaned/ALL_ED_data_cleaned", date, ".rds"))
