...
glad_baseline <- readRDS(file = "../data_cleaned/BASELINE_glad2021-06-29.rds")
dim(glad_baseline)

edgi_baseline <- readRDS(file = "../data_cleaned/BASELINE_edgi2021-06-29.rds")
dim(edgi_baseline)

nbr_baseline <- readRDS(file = "../data_cleaned/BASELINE_nbr2021-06-29.rds")
dim(nbr_baseline)

ramp_baseline <- readRDS(file = "../data_cleaned/BASELINE_ramp2021-06-29.rds")
dim(ramp_baseline)
```
...
Merge follow up data with baseline data +++ HERE!
