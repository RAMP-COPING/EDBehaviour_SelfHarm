...
```{r export data}
glad_baseline <- readRDS(file = "../data_cleaned/NEW_baseline_glad2021-05-31.rds")
dim(glad_baseline)

edgi_baseline <- readRDS(file = "../data_cleaned/NEW_baseline_edgi2021-05-31.rds")
dim(edgi_baseline)

nbr_baseline <- readRDS(file = "../data_cleaned/NEW_baseline_nbr2021-05-31.rds")
dim(nbr_baseline)

ramp_baseline <- readRDS(file = "../data_cleaned/NEW_baseline_ramp2021-05-31.rds")
dim(ramp_baseline)
...
data.merged.with.ED.groups <- merge(data.merged2,
