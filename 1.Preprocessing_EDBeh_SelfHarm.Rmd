...
if(GLAD == TRUE){
glad.baseline.resp <- readRDS(file = "../data_raw/glad/resp_coping_glad.rds")
...
glad.baseline.resp.id <- glad.baseline.resp %>% #new dataset with ID
  ...
  select(
         ...
         cohort_name, # Sample
         startDate_baseline = startDate,
         resp.nose_throat_swab_test = resp.throat_swab_coronavirus_nose,
         resp.results_nose_throat_swab_test = resp.throat_swab_test_nose,
         resp.antibody_test = resp.coronavirus_antibody_test,
         resp.results_antibody_test = resp.results_antibody_test
         ) %>%
  add_numeric(., exclude = exclude_cols_dem) %>%
  mutate_if(is.numeric, ~na_if(., -88)) %>% # Recode missing values to NAs in numeric variables
  #mutate_if(is.numeric, ~na_if(., -99)) %>%
...
if(EDGI == TRUE){
edgi.baseline.resp <- readRDS(file = "../data_raw/edgi/resp_coping_edgi.rds")
...
if(NBR == TRUE){
nbr.baseline.resp <- readRDS(file = "../data_raw/nbr/resp_coping_nbr.rds")
...
if(RAMP == TRUE){
ramp.baseline.resp <- readRDS(file = "../data_raw/ramp/resp_ramp.rds")
...
ramp.baseline.resp.id <- ramp.baseline.resp %>% #new dataset with ID
  ...
  select(
         ...
         resp.nose_throat_swab_test = resp.throat_swab_coronavirus_nose,
         resp.results_nose_throat_swab_test = resp.throat_swab_test_nose,
         resp.antibody_test = resp.coronavirus_week_antibody_test,
         resp.results_antibody_test = resp.results_antibody_test
         ) %>%
  add_numeric(., exclude = exclude_cols_dem) %>%
  mutate_if(is.numeric, ~na_if(., -88)) %>% # Recode missing values to NAs in numeric variables
...
if(COPING == TRUE){
coping.followupa1.resp <- readRDS(file = "../data_raw/coping/resp_coping_followupa.rds")
...
coping.followupa1.resp.id <- coping.followupa1.resp %>% #new dataset with ID
  ...
  select(
         ...
         cohort_name, # Sample
         startDate_waves = startDate,
         resp.nose_throat_swab_test = resp.throat_swab_nose_test,
         resp.results_nose_throat_swab_test = resp.throat_swab_test_nose,
         resp.antibody_test = resp.coronavirus_week_antibody_test,
         resp.results_antibody_test = resp.results_antibody_test
         ) %>%
...
if(COPING == TRUE){
coping.followupa2.resp <- readRDS(file = "../data_raw/coping/resp_coping_followupa_ongoing.rds")
...
if(COPING == TRUE){
coping.followupb.resp <- readRDS(file = "../data_raw/coping/resp_coping_followupb.rds")
...
coping.followupb.resp.id <- coping.followupb.resp %>% #new dataset with ID
  ...
  select(
         ...
         cohort_name, # Sample
         startDate_waves = startDate,
         resp.nose_throat_swab_test = resp.throat_swab_nose_coronavirus,
         resp.results_nose_throat_swab_test = resp.throat_swab_test_nose,
         resp.antibody_test = resp.antibody_test_coronavirus_week,
...
if(RAMP == TRUE){
ramp.followupa.resp <- readRDS(file = "../data_raw/ramp/resp_ramp_followupa.rds")
...
ramp.followupa.resp.id <- ramp.followupa.resp %>% #new dataset with ID
  ...
  select(
         ...
         resp.nose_throat_swab_test = resp.throat_swab_nose_test,
         resp.results_nose_throat_swab_test = resp.throat_swab_test_nose,
         resp.antibody_test = resp.coronavirus_weeks_antibody_test,
         resp.results_antibody_test = resp.results_antibody_test
         ) %>%
  add_numeric(., exclude = exclude_cols_dem) %>%
  mutate_if(is.numeric, ~na_if(., -88)) %>% # Recode missing values to NAs in numeric variables
...
if(RAMP == TRUE){
ramp.followupb.resp <- readRDS(file = "../data_raw/ramp/resp_ramp_followupb.rds")
...
ramp.followupb.resp.id <- ramp.followupb.resp %>% #new dataset with ID
  ...
  select(
         ...
         resp.nose_throat_swab_test = resp.throat_swab_nose_coronavirus,
         resp.results_nose_throat_swab_test = resp.throat_swab_test_nose,
         resp.antibody_test = resp.antibody_test_coronavirus_weeks,
         resp.results_antibody_test = resp.antibody_test_results
         ) %>%
  add_numeric(., exclude = exclude_cols_dem) %>%
  mutate_if(is.numeric, ~na_if(., -88)) %>% # Recode missing values to NAs in numeric variables
...
ramp.followup.resp.id <- ramp.followup.resp.id %>%
  ...
  tidyr::pivot_wider(id_cols = ID,
    names_from = wave_resp, 
                     values_from = c(resp.nose_throat_swab_test,
         resp.results_nose_throat_swab_test,
         resp.antibody_test,
...
ramp.followup.resp.id <- ramp.followup.resp.id  %>%
  select(ID,
         `resp.nose_throat_swab_test_.Wave_1a`,
         `resp.nose_throat_swab_test_.Wave_1b`,
         `resp.nose_throat_swab_test_.Wave_2a`,
         `resp.nose_throat_swab_test_.Wave_2b` ,
         `resp.nose_throat_swab_test_.Wave_3a`,
         `resp.nose_throat_swab_test_.Wave_3b` , 
         `resp.nose_throat_swab_test_.Wave_4a`,
         `resp.nose_throat_swab_test_.Wave_4b`,
         `resp.nose_throat_swab_test_.Wave_5a`,
         `resp.nose_throat_swab_test_.Wave_6b`,
         `resp.nose_throat_swab_test_.Wave_7a`,
         `resp.nose_throat_swab_test_.Wave_8b`,
         `resp.nose_throat_swab_test_.Wave_9a`,
         `resp.nose_throat_swab_test_.Wave_10b`,
         `resp.nose_throat_swab_test_.Wave_11a`,
         `resp.nose_throat_swab_test_.Wave_12b`,
         
         `resp.results_nose_throat_swab_test_.Wave_1a`,
         `resp.results_nose_throat_swab_test_.Wave_1b`,
         `resp.results_nose_throat_swab_test_.Wave_2a`,
         `resp.results_nose_throat_swab_test_.Wave_2b` ,
         `resp.results_nose_throat_swab_test_.Wave_3a`,
         `resp.results_nose_throat_swab_test_.Wave_3b` , 
         `resp.results_nose_throat_swab_test_.Wave_4a`,
         `resp.results_nose_throat_swab_test_.Wave_4b`,
         `resp.results_nose_throat_swab_test_.Wave_5a`,
         `resp.results_nose_throat_swab_test_.Wave_6b`,
         `resp.results_nose_throat_swab_test_.Wave_7a`,
         `resp.results_nose_throat_swab_test_.Wave_8b`,
         `resp.results_nose_throat_swab_test_.Wave_9a`,
         `resp.results_nose_throat_swab_test_.Wave_10b`,
         `resp.results_nose_throat_swab_test_.Wave_11a`,
         `resp.results_nose_throat_swab_test_.Wave_12b`,
         
          `resp.antibody_test_.Wave_1a`,
         `resp.antibody_test_.Wave_1b`,
         `resp.antibody_test_.Wave_2a`,
         `resp.antibody_test_.Wave_2b` ,
         `resp.antibody_test_.Wave_3a`,
         `resp.antibody_test_.Wave_3b` , 
         `resp.antibody_test_.Wave_4a`,
         `resp.antibody_test_.Wave_4b`,
         `resp.antibody_test_.Wave_5a`,
         `resp.antibody_test_.Wave_6b`,
         `resp.antibody_test_.Wave_7a`,
         `resp.antibody_test_.Wave_8b`,
         `resp.antibody_test_.Wave_9a`,
         `resp.antibody_test_.Wave_10b`,
         `resp.antibody_test_.Wave_11a`,
         `resp.antibody_test_.Wave_12b`,
