...
# Read in data
```{r Read in dataset}
dat <- readRDS(paste0(filepath_saved_data, "final_dat_no_dup_entries2022-06-20.rds"))
```
...
dat <- dat %>%
  mutate(increased_loneliness_during_pandemic =
           case_when(
             lone.similar_felt_pandemic == "No different" ~ "No", # These people did not get asked about their prepandemic loneliness, becasue they indicated that they're had been no change.
