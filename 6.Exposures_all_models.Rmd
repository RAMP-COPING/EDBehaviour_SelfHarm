...
# Read in data
```{r Read in dataset}
dat <- readRDS(paste0(filepath_saved_data, "final_dat_no_dup_entries2022-09-23.rds"))
```
...
dat <- dat %>%
  mutate(increased_loneliness_during_pandemic =
           case_when(
             lone.similar_felt_pandemic == "No different" ~ "No", # These people did not get asked about their prepandemic loneliness, becasue they indicated that there had been no change.
...
dat %>%
  filter(is.na(increased_loneliness_during_pandemic) &
          (!is.na(loneliness_prepandemic_count) &
           !is.na(loneliness_pandemic_count))) # There should not be anyone who has scores for both prepandemic and pandemic loneliness who were not assigned scores
           ...
           dem.unwell_coronavirus_weeks_physical_.Wave_16b =="Yes" ~ "16b",
              ...
              # No at least once
               ...
               resp.coronavirus_test_nosethroat_swab == "No" | # Not had an nose throat swab test / not passed screener
                resp.results_nosethroat_swab_test == "Not passed screener" | # Not passed screener
                ...
                resp.coronavirus_antibody_test == "No" | # Not had an antibody test / not passed screener
                 resp.results_antibody_test == "Not passed screener" | # Not passed antibody screener
             ...
             virus.back_positive_antibodies_tests_.Wave_16b == "Unsure/inconclusive" ~ "No"
              )
              )
              ...
              # Not lost someone
                     ...
                     (dem.health_of_a_relative_.Wave_1a == "Not Health of a relative" | # Screener question
                      ...
                      (dem.health_of_a_relative_.Wave_2b == "Not Health of a relative" | # Screener question
                       ...
                       dem.coronavirus_relative_ill_suspected_.Wave_2b == "Unsure" |  # Not sure if ill relative has passed
