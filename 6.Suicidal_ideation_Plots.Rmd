...
##NEW experience of suicidal ideation; phases
```{r}

dat <- dat %>%
  mutate(new_suicidal_ideation_each_wave =
           case_when(
...
#Check
dat %>%
  freq(new_suicidal_ideation_each_wave)
...
#Phase 1a
phase1a <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_1a)
         )
...
#Phase 1b
phase1b <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_1b)
         )
...
#Phase 2a
phase2a <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_2a)
         )
...
#Phase 2b
phase2b <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_2b)
         )
...
#Phase 3a
phase3a <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_3a)
         )
...
#Phase 3b
phase3b <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_3b)
         )
...
#Phase 4a
phase4a <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_4a)
         )
...
#Phase 4b
phase4b <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_4b)
         )
...
#Phase 5a
phase5a <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_5a)
         )
...
#Phase 6b
phase6b <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_6b)
         )
...
#Phase 7a
phase7a <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_7a)
         )
...
#Phase 8b
phase8b <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_8b)
         )
...
#Phase 9a
phase9a <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_9a)
         )
...
#Phase 10b
phase10b <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_10b)
         )
...
#Phase 11a
phase11a <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_11a)
         )
...
#Phase 12b
phase12b <- dat %>%
  filter(!is.na(taf.worth_living_life_people_.Wave_12b)
         )
