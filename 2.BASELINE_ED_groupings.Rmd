...
```
17/01/22: There are 11 people who we have been able to identify as having pandemic binge eating (i.e., binge eating that started during the pandemic).
...
Now, there are 871 people who we can not classify. Either 'Yes' or missing for the BE question. And 'Not sure', 'Yes' (but not indicated which EDs), 'No' (but 'Yes' or NA for BE) for suspected eating disorder diagnosis.
...
Now, there are 898 people who we can not classify. Either 'Yes' or missing for the LW question. And 'Not sure', 'Yes' (but not indicated which EDs), 'No' (but 'Yes' or NA for LW) for the MHD.
...
```{r Read in data RAMP EDEQ baseline}
ramp.edeq.baseline <- readRDS(file =  paste0(filepath_saved_data, "BASELINE_ramp2022-02-21.rds"))
...
ramp_dat %>%
  freq(lifetime_low_weight_baseline_numeric)
```
17/01/22: There are 8603 people missing (i.e., have put PNTA/Don't know/Seen but not answered for the MHD anorexia question at RAMP baseline)
